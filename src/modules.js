...
export const MODULES = [
  {
    ...
    hook: {
      ...
      isTrue: false,
      accentWords: ['Black Death', 'garlic and prayer'],
      explanation: 'Medieval doctors had no concept of bacteria or infection. Around 1 in 3 people in England died — and every treatment failed.',
      storyLines: [
  ...
  // ─────────────────────────────────────────────────────────────────────────────
  {
    ...
    screens: [
      // ── SCREEN 0: Plant Cell Interactive Image ─────────────────────────────
      {
        ...
        title: 'Inside a\nPlant Cell',
        introText: 'Plant cells contain specialised structures called organelles. Each one has a job that helps the cell survive.',
        image: '/figures/plant-cell.png',
        imageAlt: 'Illustration of a plant cell showing major organelles',
        ctaLabel: 'Explore cell',
        hotspots: [
          {
            id: 'cell_wall', x: 22, y: 8,
