...
export default function ChapterPlayer({ chapter, onBack, onChapterComplete }) {
  ...
  // Initial values are derived by computeInitialChapterState (moduleNavigation.js).
  ...
  // getChapterGate (moduleNavigation.js); the JSX and side effects below stay here.
