  ...
  return (
    <>
      ...
      <div style={{ position: 'fixed', inset: 0, zIndex: 10000, isolation: 'isolate', background: bg, display: 'flex', flexDirection: 'column', overflow: 'hidden' }}>
        ...
        <div style={{ position: 'relative', zIndex: 20, background: bg, borderBottom: '1px solid rgba(255,255,255,0.07)', display: 'flex', alignItems: 'center', justifyContent: 'space-between', padding: '0 16px', height: 52, flexShrink: 0 }}>
        ...
        <ScreenTextBlock
          ...
          accent={accent}
          inset
          style={{ background: 'rgba(255,255,255,0.025)', borderBottom: '1px solid rgba(255,255,255,0.06)', flexShrink: 0, position: 'relative', zIndex: 1 }}
        ...
        {showTabs && <div style={{ padding: '10px 16px 8px', borderBottom: '1px solid rgba(255,255,255,0.07)', flexShrink: 0, position: 'relative', zIndex: 1 }}>
        ...
        <div className="fte-scroll" style={{ flex: 1, overflowY: 'auto', padding: `${SCREEN_TEXT_LAYOUT.blockGap}px ${SCREEN_TEXT_LAYOUT.mobileInset}px`, paddingBottom: bottomPanelHeight > 0 ? bottomPanelHeight + 16 : 80, WebkitOverflowScrolling: 'touch', position: 'relative', zIndex: 1 }}>
        ...
        {!isReveal && <div style={{ flexShrink: 0, padding: '12px 16px calc(12px + env(safe-area-inset-bottom, 0px))', background: bg, borderTop: '1px solid rgba(255,255,255,0.06)', position: 'relative', zIndex: 2 }}>
