    ...
    <>
      ...
      <div style={{ position: 'fixed', inset: 0, zIndex: 10000, isolation: 'isolate', background: bg, display: 'flex', flexDirection: 'column', overflow: 'hidden' }}>
        ...
        <ScreenTextBlock
          ...
          accent={accent}
          inset
          style={{ background: 'transparent', borderBottom: 'none', flexShrink: 0, position: 'relative', zIndex: 1, paddingBottom: 8 }}
        ...
        {showTabs && <div style={{ padding: '4px 16px 8px', flexShrink: 0, position: 'relative', zIndex: 1 }}>
        ...
        {!isReveal && <div style={{ flexShrink: 0, padding: '12px 16px calc(12px + env(safe-area-inset-bottom, 0px))', background: 'linear-gradient(180deg, rgba(8,9,13,0) 0%, rgba(8,9,13,0.92) 28%, rgba(8,9,13,1) 100%)', position: 'relative', zIndex: 2 }}>
