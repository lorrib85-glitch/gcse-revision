  ...
  return (
    <div style={{ display: 'grid', gap: 14 }}>
      <section style={{ padding: 16, borderRadius: 20, background: 'linear-gradient(180deg, rgba(245,238,225,0.05), rgba(8,9,13,0.18))', border: '1px solid rgba(245,238,225,0.08)' }}>
        ...
        <div style={{ ...TYPE.bodySmallText, color: 'rgba(255,255,255,0.5)', marginBottom: 8 }}>Slide your judgement along the mark line before the examiner reveals theirs.</div>
        <ScoreNumberLine
          value={guessedMark}
          min={0}
          max={examiner.marks}
