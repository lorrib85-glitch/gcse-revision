...
- CONCLUSION: Government action was crucial as the mechanism that distributed and applied other improvements — but it relied on science, technology and individuals to have something worth distributing. The strongest argument for government primacy: without the NHS, advances in medicine reached only those who could pay. Government action made improvement universal. Award marks for: sustained argument, specific evidence for and against, justified conclusion`,
  ...
  // ── Episode 14: Hell in the Trenches ──────────────────────────────────────
...
War creates urgent demand for faster, better treatment. The First World War produced enormous numbers of wounded men with injuries on a scale doctors had not faced before: broken bones, blood loss, gas attacks, infections, facial injuries, and shell shock.`,
...

      {
        ...
        scenes: [
          {
            image: '/headers/history-medicine-trenches.png',
          ...
          {
            image: '/headers/history-medicine-trenches.png', // TODO: /figures/history/medicine/western-front/trench-system.webp
          ...
          {
            image: '/headers/history-medicine-trenches.png', // TODO: /figures/history/medicine/western-front/wounded-evacuation.webp
          ...
          {
            image: '/headers/history-medicine-trenches.png', // TODO: /figures/history/medicine/western-front/medical-post.webp
...

      {
        ...
        stage: 'Chain of evacuation',
        label: 'Match the treatment stage',
        subject: 'History',
        title: 'Match the treatment stage',
        instruction: 'Match each part of the evacuation chain to its job.',
        weakAreaCategory: 'Western Front: Chain of Evacuation',
        backgroundImage: '/headers/history-medicine-trenches.png',
        pairs: [
          {
            id: 'stretcher-bearers',
            term: 'Stretcher bearers',
            answer: 'Carried wounded men from the front line',
            weakGroup: 'Evacuation chain',
          },
          {
            id: 'rap',
            term: 'Regimental Aid Post',
            answer: 'Basic first aid close to the front line',
            weakGroup: 'Evacuation chain',
          },
          {
            id: 'ads',
            term: 'Advanced/Main Dressing Station',
            answer: 'Treated more serious injuries around 400 metres behind the line',
            weakGroup: 'Evacuation chain',
          },
          {
            id: 'ccs',
            term: 'Casualty Clearing Station',
            answer: 'Performed most surgery and triage, often near railways',
            weakGroup: 'Evacuation chain',
          },
          {
            id: 'base-hospital',
            term: 'Base Hospital',
            answer: 'Longer-term treatment on the French coast',
            weakGroup: 'Evacuation chain',
          },
          {
            id: 'fany',
            term: 'FANY',
            answer: 'Women who drove ambulances along the chain',
            weakGroup: 'People',
          },
          {
            id: 'ramc',
            term: 'RAMC',
            answer: 'The British Army medical corps responsible for medical provision',
            weakGroup: 'People',
          },
        ],
      },
        ...
        blocks: [
          {
            ...
            atmosphereImage: '/headers/history-medicine-trenches.png',
            steps: [
              {
                id: 'problem',
