...
export function checkIntegrity(catalogue) {
  ...
  // the loader registry could not be generated from the catalogue.
  //
  // The one path the runtime loads for an id that is NOT a chapter — the hidden
  // Renaissance bundle — is compatibility data, not curriculum, and
  // `compatibility/index.js` checks it against these same paths.
