// Canonical chapter metadata catalogue.
//
...
export const CHAPTERS = [
  ...
  },
  {
    ...
    // chapter unreachable and orphaning its registry entry.
...
// ─── Chapter availability governance ─────────────────────────────────────────
// Single source of truth for whether a chapter is real, usable content.
//
...
// no change. A chapter may set an explicit `availability` to override — e.g. to
...
// True only for chapters a learner can actually open and complete. The planner
// and weak-spot recovery must gate chapter selection on this so an unbuilt stub
