...
export default {
  ...
  documentation: {
    ...
    governanceRules: [
      ...
      'Chapter-building rule: a normal chapter is buildable by adding chapter metadata to src/chapters.js, adding its content loader to src/content/chapterContentRegistry.js, composing registered screens and blocks from src/data/screenRegistry.js, adding the chapter id to exactly one parent module in src/data/modules.js, and passing schema and architecture tests. Adding a normal chapter must not require editing ChapterPlayer, ScreenRenderer, app navigation or progress persistence. Enforced by tests/architecture/chapter-authoring-boundary.test.js.'
    ],
    notes: []
  },
  decision: null,
