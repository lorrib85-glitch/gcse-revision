...
export const episode = {
  ...
  screens: [
    ...
    },
    {
      ...
      sub: 'And why it mattered for medicine.',
      blocks: [
        {
          type: 'explainReveal',
          intro: 'Vesalius did not just correct Galen. He changed how doctors thought knowledge should work.',
          atmosphereImage: '/headers/history-medicine-germ-bridge.png',
          steps: [
            {
              id: 'galens-errors',
              statement: 'Galen made errors because he mostly dissected',
              emphasis: 'animals, not humans.',
              detail: 'He assumed human anatomy was the same as pigs, monkeys and goats. It was not.',
            },
            {
              id: 'vesalius-dissects',
              statement: 'Vesalius dissected human bodies and found',
              emphasis: 'over 300 mistakes.',
              detail: 'The jaw was one bone, not two. The heart septum did not have the holes Galen described.',
            },
            {
              id: 'authority-challenged',
              statement: 'An ancient authority was challenged',
              emphasis: 'with observable evidence.',
              detail: 'This was a new method: look, test and compare instead of accepting old authority.',
            },
            {
              id: 'knowledge-not-treatment',
              statement: 'But anatomy improved faster than treatment.',
              emphasis: 'Doctors still used bloodletting and the Four Humours.',
              detail: 'Better knowledge of the body did not immediately create better cures.',
            },
          ],
          reflectionPrompt: 'Why did correcting Galen’s anatomy not immediately change treatment?',
        },
      ],
    },
    {
