...
export default {
  ...
  stageNavigation: [
    ...
    { id: 'part-4', title: 'The Medieval Treatment Toolkit', description: 'Physicians, barber surgeons, apothecaries, hospitals and prevention.', screenIndex: 12 },
    { id: 'part-5', title: 'Why the System Survived', description: 'Continuity, agents of change/continuity and the coherent-but-wrong system.', screenIndex: 25 },
    { id: 'part-6', title: 'Exam Prep: Explain the Grip of Galen', description: 'Examiner traps, mark-scheme thinking and exam practice.', screenIndex: 28 },
  ],
  ...
  screens: [
...

    {
      type: 'oppositeQualitiesReveal',
      stage: 'Galen',
      label: 'Wet and dry symptoms',
      title: 'Wet or dry?',
      copy: 'The same idea was used for symptoms linked to moisture.',
      leftConcept: { label: 'Wet', icon: '💧', items: ['Sweating', 'Runny nose', 'Watery eyes', 'Phlegm'] },
      rightConcept: { label: 'Dry', icon: '✦', items: ['Cracked lips', 'Dry cough', 'Thirst'] },
      sequence: [
...

    {
      ...
      judgementPrompt: 'Choose one belief. Explain how it shaped what medieval people did, and how it linked to another belief.',
      factors: [
        {
          id: 'supernatural',
          title: "God's punishment",
          subtitle: 'Divine retribution',
          whatItMeans: 'Most people believed sin angered God, who sent illness as punishment.',
          whyItMattered: 'It made prayer, confession and pilgrimage — not medicine — the logical response.',
          linkedFactor: "The Church's authority made this the dominant explanation, as it did for Galen.",
        },
        {
          id: 'astrology',
          title: 'Stars and planets',
          subtitle: 'Astrology',
          whatItMeans: 'Physicians believed the alignment of the planets controlled bodily health.',
          whyItMattered: 'Doctors consulted zodiac charts before bloodletting or prescribing — the Black Death was blamed on a planetary conjunction.',
          linkedFactor: 'Astrology decided when to rebalance the humours.',
        },
        {
          id: 'humours',
          title: 'Four humours',
          subtitle: "Galen's theory",
          whatItMeans: 'Illness meant the four humours — blood, phlegm, yellow bile and black bile — were out of balance.',
          whyItMattered: 'Treatment aimed to restore balance through bloodletting, purging and diet.',
          linkedFactor: "This was Galen's theory, protected by his authority.",
        },
        {
          id: 'miasma',
          title: 'Bad air (miasma)',
          subtitle: 'Foul smells',
          whatItMeans: 'Foul-smelling air was thought to cause disease, so people burned herbs and avoided marshes.',
          whyItMattered: 'It accidentally helped: clearing rubbish reduced real disease, even though the reasoning was wrong.',
          linkedFactor: 'Like the humours, it was a natural — not supernatural — explanation.',
        },
        {
          id: 'galen',
          title: "Galen's authority",
          subtitle: 'Frozen knowledge',
          whatItMeans: 'The Church endorsed Galen as truth, and medical schools taught only his texts.',
          whyItMattered: 'Challenging Galen risked punishment, so medical ideas were frozen for over 1,000 years.',
          linkedFactor: 'His authority protected the four humours from being questioned.',
        },
        {
          id: 'experience',
          title: 'Practical experience',
          subtitle: 'Folk cures',
          whatItMeans: 'Wise women and apothecaries used centuries of herbal knowledge alongside the theories.',
          whyItMattered: 'Some remedies genuinely worked — willow bark contains salicin, related to aspirin.',
          linkedFactor: 'It worked through chemistry, not the theories the physicians trusted.',
        },
      ],
    },
