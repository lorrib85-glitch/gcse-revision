...
The Church preserved ancient texts and backed Galen's authority. Without microscopes or germ theory, no better explanation existed. Humoral logic was internally consistent — wrong premises, logical conclusions. Some treatments accidentally helped (rest, fluids, herbal remedies), making the flawed theory seem credible. Multiple explanations coexisted — people believed God, humours, miasma, and astrology simultaneously.`,
...

    {
      ...
      intro: 'Follow bubonic plague through the body, from first contact to death. Tap each stage to reveal what happened.',
      steps: [
        {
          id: 'infection',
          icon: '🦟',
          label: 'Infection (day 1–2)',
          detail: 'A flea carrying Yersinia pestis bacteria bites the skin. The bacteria enter the lymphatic system. The infected person feels nothing yet.',
        },
        {
          id: 'buboes',
          icon: '🔴',
          label: 'Buboes form (day 3–5)',
          detail: 'Painful egg-sized swellings (buboes) appear in the lymph nodes — groin, armpit, or neck.',
        },
        {
          id: 'fever',
          icon: '🤒',
          label: 'Fever and collapse (day 5–6)',
          detail: 'The immune system is overwhelmed. Fever, shivering, vomiting and exhaustion develop rapidly.',
        },
        {
          id: 'blood',
          icon: '🩸',
          label: 'Blood poisoning (day 6+)',
          detail: 'The bacteria spread through the bloodstream. Skin can darken from internal bleeding — giving the disease its later name.',
        },
        {
          id: 'forms',
          icon: '🫁',
          label: 'One disease, three forms',
          detail: 'This chain describes bubonic plague — buboes, the most common form. Pneumonic plague infected the lungs and spread through coughing, person to person. Septicaemic plague infected the blood and could kill within hours. Medieval people never realised these were the same disease.',
        },
      ],
    },
      ...
      questions: [
        {
          ...
          correct: 0,
          explanation: 'Bubonic plague was caused by Yersinia pestis bacteria. Fleas living on black rats carried it to humans. Medieval people could not know this — they had no microscopes and no germ theory.',
        },
      ],
    },
...

    {
      ...
      questions: [
        {
          type: 'choice',
          question: 'A medieval person believes the plague is God\'s punishment for sin. What treatment made sense to them?',
          options: ['Prayer and repentance', 'Bloodletting', 'Burning herbs', 'Consulting astrological charts'],
          correct: 0,
          explanation: 'If God sent the plague, prayer made sense. So did confession, fasting and repentance. People hoped God would forgive them and end the disease.',
        },
        {
          type: 'choice',
          question: 'A medieval person believes miasma — poisonous air from rotting matter — is causing disease. What treatment made sense to them?',
          options: ['Burn herbs and clean foul smells', 'Pilgrimage', 'Purging', 'Bloodletting'],
          correct: 0,
          explanation: 'If bad air caused disease, removing the smell seemed logical. People burned herbs. They also cleaned streets and carried sweet-smelling flowers.',
        },
        {
          type: 'choice',
          question: 'A medieval person believes the planets are disturbing the body. What treatment made sense to them?',
          options: ['Consult astrological charts', 'Quarantine rules', 'Prayer and repentance', 'Bloodletting'],
          correct: 0,
          explanation: 'If planets controlled the body, treatment had to be timed carefully. Physicians used astrological charts and Zodiac Man diagrams to choose a safe day.',
        },
        {
          type: 'choice',
          question: 'A medieval person believes the four humours — blood, phlegm, yellow bile and black bile — are out of balance. What treatment made sense to them?',
          options: ['Bloodletting or purging', 'Consult astrological charts', 'Prayer and repentance', 'Burning herbs'],
          correct: 0,
          explanation: 'If disease came from too much of one humour, doctors removed fluid to restore balance. They used bloodletting, vomiting or diarrhoea.',
        },
      ],
    },
...

    {
      ...
      intro: 'The plague killed so many people that England could not simply return to normal. Tap each step to see what followed.',
      steps: [
        { id: 'blackdeath', label: 'Black Death in England (1348–49)', detail: 'Between one-third and one-half of the population died.' },
        { id: 'labour',     label: 'Labour shortage (1349)',           detail: 'There were fewer workers. Peasants demanded higher wages.' },
        { id: 'statute',    label: 'Statute of Labourers (1351)',       detail: 'The government tried to cap wages and force workers back to pre-plague conditions.' },
        { id: 'revolt',     label: "Peasants' Revolt (1381)",          detail: 'Resentment over wages, rights and taxes contributed to rebellion.' },
      ],
    },
