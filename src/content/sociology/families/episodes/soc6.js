export default {
  ...
  "recall": {
    "questions": [
      {
        "type": "truefalse",
        "question": "Positivist sociologists prefer to work with quantitative data.",
        "isTrue": true
      },
      {
        "type": "choice",
        "question": "Young and Willmott argued working-class families had...",
        "options": [
          "Isolated nuclear units with few community ties",
          "Strong extended family networks and mutual support",
          "Mainly dysfunctional and conflictual relationships"
        ],
        "correct": 1
      },
      {
        "type": "connection",
        "question": "Oakley's research challenged earlier studies because...",
        "options": [
          {
            "text": "She used a much larger and more diverse sample",
            "icon": "people"
          },
          {
            "text": "She showed women still did most domestic work even when employed",
            "icon": "lightbulb"
          },
          {
            "text": "She proved the nuclear family was the ideal family form",
            "icon": "house"
          }
        ],
        "correct": 1
    ...
    },
    {
      ...
      "blocks": [
        ...
        },
        {
          ...
          "items": [
            {
              "label": "Earning a wage",
              "col": 0,
              "explanation": "The classic instrumental role — financial provision for the family."
            },
            {
              "label": "Comforting a sick child",
              "col": 1,
              "explanation": "Emotional care — the expressive role in action."
            },
            {
              "label": "Paying rent and bills",
              "col": 0,
              "explanation": "Economic stability — instrumental role."
            },
            {
              "label": "Creating warmth and security at home",
              "col": 1,
              "explanation": "The emotional environment of the family — expressive role."
            },
            {
              "label": "Going out to work full-time",
              "col": 0,
              "explanation": "Financial provision — instrumental."
            },
            {
              "label": "Providing emotional support to family members",
              "col": 1,
              "explanation": "Emotional labour — expressive role."
            }
          ],
    ...
    },
    {
      ...
      "blocks": [
        ...
        },
        {
          ...
          "options": [
            {
              "text": "Young & Willmott — this is the symmetrical family.",
              "correct": true
            },
            {
              "text": "Parsons — instrumental and expressive roles are both being fulfilled.",
              "correct": false
            },
            {
              "text": "Oakley — this proves domestic inequality still exists.",
              "correct": false
            }
          ],
      ...
      "blocks": [
        ...
        },
        {
          ...
          "options": [
            ...
            {
              "text": "Expressive role",
              "correct": false
            },
            {
              "text": "Symmetrical burden",
              "correct": false
            },
            {
              "text": "Domestic symmetry",
              "correct": false
            }
          ],
      ...
      "blocks": [
        {
          ...
          "options": [
            {
              "text": "Agree — this matches their symmetrical family argument.",
              "correct": true
            },
            {
              "text": "Disagree — they never claimed families were fully equal.",
              "correct": false
            },
            {
              "text": "Partly agree — they thought equality was possible in theory.",
              "correct": false
            }
          ],
        ...
        },
        {
          ...
          "options": [
            {
              "text": "Disagree — women still carry a disproportionate domestic burden.",
              "correct": true
            },
            {
              "text": "Agree — equality has been largely achieved.",
              "correct": false
            },
            {
              "text": "Partly agree — but only for middle-class families.",
              "correct": false
            }
          ],
        ...
        },
        {
          ...
          "options": [
            {
              "text": "Partly agree — but argue role specialisation still serves a function.",
              "correct": true
            },
            {
              "text": "Fully agree — equality was always the goal.",
              "correct": false
            },
            {
              "text": "Disagree — he wanted strict traditional roles maintained.",
              "correct": false
            }
          ],
          ...
          "sentences": [
            {
              ...
              "answer": "stability",
              "hints": [
                "The word means things stay ordered and predictable.",
                "Parsons thought society needed this — starts with \"s.\""
              ]
            },
            {
              ...
              "answer": "symmetrical",
              "hints": [
                "Both sides are balanced — like a mirror image.",
                "Starts with \"s.\" Young & Willmott's key term."
              ]
            },
            {
              ...
              "answer": "labour",
              "hints": [
                "The word for work and effort.",
                "Domestic division of _____."
              ]
            },
            {
              ...
              "answer": "expressive",
              "hints": [
                "It's about expressing feelings and care.",
                "The opposite of the instrumental role."
              ]
            },
            {
              ...
              "hints": [
                "The process of learning how society works.",
                "Primary _____. Happens in the family first."
              ]
            }
          ],
          "wordBank": [
      ...
      "blocks": [
        ...
        },
        {
          ...
          "cards": [
            {
              "front": "Parsons",
              "back": "Functionalist. Instrumental/expressive roles. Primary socialisation. Family = social stability."
            },
            {
              "front": "Young & Willmott",
              "back": "1973 study. Symmetrical family. Argued roles were becoming more equal."
            },
            {
              "front": "Oakley",
              "back": "Feminist. Challenged equality claim. Domestic division of labour. Emotional labour. Patriarchy."
            },
            {
              "front": "Symmetrical family",
              "back": "Young & Willmott's concept — shared domestic roles, joint decision-making, greater equality."
            },
            {
              "front": "Domestic division of labour",
              "back": "Oakley's focus — who does the housework, childcare and emotional work."
            },
            {
              "front": "Primary socialisation",
              "back": "Parsons' concept — learning norms and values from family, before school or peers."
            }
          ]
        }
      ]
