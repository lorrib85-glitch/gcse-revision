export default {
  ...
  "recall": {
    "questions": [
      {
        "type": "truefalse",
        "question": "Durkheim believed society was held together by shared values.",
        "isTrue": true
      },
      {
        "type": "choice",
        "question": "Marxists believe social institutions mainly serve...",
        "options": [
      ...
      {
        "type": "connection",
        "question": "Functionalism and Marxism disagree most about...",
        "options": [
          {
            "text": "Whether education and family actually exist",
            "icon": "book"
          },
          {
            "text": "Whether society is built on cooperation or conflict",
            "icon": "people"
          },
          {
            "text": "The impact of technology on social change",
            "icon": "device"
          }
        ],
        "correct": 1
    ...
    },
    {
      ...
      "blocks": [
        ...
        },
        {
          ...
          "items": [
            {
              "label": "Society is based on class conflict",
              "col": 0,
              "explanation": "Marxism argues that class conflict — between bourgeoisie and proletariat — is the driving force of society."
            },
            {
              "label": "Society is like a human body: all parts work together",
              "col": 1,
              "explanation": "Functionalism uses the \"organic analogy\" — each institution (school, family, law) plays a role in keeping society healthy."
            },
            {
              "label": "The ruling class controls the economy and the law",
              "col": 0,
              "explanation": "Marx argued the bourgeoisie control not just the economy, but also the ideas, laws and institutions that justify their power."
            },
            {
              "label": "Shared values hold society together",
              "col": 1,
              "explanation": "Durkheim argued that social cohesion comes from a shared set of values — the \"collective conscience\" — that most people agree on."
            },
            {
              "label": "Schools reinforce class inequality",
              "col": 0,
              "explanation": "Marxists see education as a tool of the ruling class — teaching working-class children to accept their place and obey authority."
            },
            {
              "label": "Schools prepare children for their role in society",
              "col": 1,
              "explanation": "Functionalists argue schools serve society by transmitting values, developing skills and allocating people to appropriate occupational roles."
            },
            {
              "label": "Capitalism exploits the working class",
              "col": 0,
              "explanation": "Marx's central argument: capitalists profit by paying workers less than the value they produce — this is exploitation."
            },
            {
              "label": "Inequality can be functional and necessary",
              "col": 1,
              "explanation": "Functionalists (e.g. Davis and Moore) argue some inequality is needed to motivate talented people into the most important roles."
            }
          ],
    ...
    },
    {
      ...
      "blocks": [
        ...
        },
        {
          ...
          "options": [
            {
              "text": "They own the means of production — factories, land and capital",
              "correct": true
            },
            {
              "text": "They are elected by the people to lead society",
              "correct": false
            },
            {
              "text": "They work harder than anyone else in society",
              "correct": false
            },
            {
              "text": "They have better education than the working class",
              "correct": false
            }
          ],
    ...
    },
    {
      ...
      "blocks": [
        ...
        },
        {
          ...
          "options": [
            {
              "text": "Exploitation — workers produce more value than they are paid",
              "correct": true
            },
            {
              "text": "Social cohesion — shared goals are holding the business together",
              "correct": false
            },
            {
              "text": "Meritocracy — the owner earned more by working harder",
              "correct": false
            },
            {
              "text": "Socialisation — workers are learning new norms",
              "correct": false
            }
          ],
        ...
        },
        {
          ...
          "options": [
            {
              "text": "Workers believe the system is fair, even though it exploits them",
              "correct": true
            },
            {
              "text": "Workers are unaware that they are being watched by the government",
              "correct": false
            },
            {
              "text": "Workers think they are working class when they are actually middle class",
              "correct": false
            },
            {
              "text": "Workers dream about a communist revolution",
              "correct": false
            }
          ],
          ...
          "sentences": [
            {
              ...
              "answer": "bourgeoisie",
              "hints": [
                "The ruling class — starts with \"b.\"",
                "The French word Marx used for the factory-owning class."
              ]
            },
            {
              ...
              "answer": "proletariat",
              "hints": [
                "The opposite of bourgeoisie — starts with \"p.\"",
                "Workers who own nothing except their ability to work."
              ]
            },
            {
              ...
              "answer": "exploitation",
              "hints": [
                "The word for taking more than is fair.",
                "Workers produce £200 of value but are paid £50 — the difference is..."
              ]
            },
            {
              ...
              "hints": [
                "Two words. The second is \"consciousness.\"",
                "Workers believe the system is fair — but they are wrong. This is..."
              ]
            },
            {
              ...
              "hints": [
                "Two words. Both are very common in sociology.",
                "The struggle between the bourgeoisie and the proletariat is called..."
              ]
            }
          ],
    ...
    },
    {
      ...
      "blocks": [
        ...
        },
        {
          ...
          "items": [
            {
              "label": "Minimum wage legislation",
              "col": 0,
              "explanation": "A legal minimum wage limits how much owners can cut pay — directly benefiting workers. Marxists would still argue it is set too low to threaten profit."
            },
            {
              "label": "Tax breaks for corporations",
              "col": 1,
              "explanation": "Corporate tax cuts increase profits for shareholders and business owners — a classic example of the state serving bourgeois interests."
            },
            {
              "label": "Zero-hours contracts",
              "col": 1,
              "explanation": "Zero-hours contracts give employers maximum flexibility to cut costs — workers have no guaranteed income or job security."
            },
            {
              "label": "Free universal healthcare",
              "col": 2,
              "explanation": "Healthcare benefits workers by keeping them alive and healthy. But it also benefits owners — a healthy workforce is a productive one."
            },
            {
              "label": "Laws against strikes",
              "col": 1,
              "explanation": "Anti-strike legislation limits workers' ability to organise — protecting the profit-making power of business owners."
            },
            {
              "label": "Universal state education",
              "col": 2,
              "explanation": "Education benefits workers (access to knowledge) but Marxists argue it mainly benefits owners by training an obedient, skilled workforce cheaply."
            }
          ],
    ...
    },
    {
      ...
      "blocks": [
        ...
        },
        {
          ...
          "options": [
            {
              "text": "Society is like a body — each institution plays a vital role in keeping it functioning",
              "correct": true
            },
            {
              "text": "Society is like a garden — it grows naturally without interference",
              "correct": false
            },
            {
              "text": "Society is made up of biological instincts that we inherit at birth",
              "correct": false
            },
            {
              "text": "Society is like a machine — efficient but cold and without meaning",
              "correct": false
            }
          ],
    ...
    },
    {
      ...
      "blocks": [
        ...
        },
        {
          ...
          "columns": [
            {
              "label": "MARXIST VIEW\nInstitutions serve the ruling class",
              "color": "#FF5D73",
              "bg": "rgba(255,93,115,.07)"
            },
            {
              "label": "FUNCTIONALIST VIEW\nInstitutions serve society as a whole",
              "color": "#4B90FF",
              "bg": "rgba(75,144,255,.07)"
            }
          ],
          "items": [
            {
              "label": "Schools teach children to obey authority and accept inequality",
              "col": 0,
              "explanation": "Marxists (e.g. Bowles and Gintis) argue the \"hidden curriculum\" of school — obedience, punctuality, accepting hierarchy — prepares workers to accept exploitation without question."
            },
            {
              "label": "Schools socialise children into shared values and develop skills for society",
              "col": 1,
              "explanation": "Functionalists (e.g. Parsons) see schools as performing vital functions: value transmission, skills development, role allocation — all benefiting society as a whole."
            },
            {
              "label": "The law protects the property rights of the rich",
              "col": 0,
              "explanation": "Marxists argue laws protecting private property serve bourgeois interests. Most crime laws punish the poor — while white-collar crime by the rich goes largely unpunished."
            },
            {
              "label": "The law maintains social order and protects everyone equally",
              "col": 1,
              "explanation": "Functionalists see law as a shared social contract — it reflects collective values and protects all members of society from harm and chaos."
            },
            {
              "label": "Religion distracts workers from their exploitation (\"opium of the people\")",
              "col": 0,
              "explanation": "Marx famously said religion was the \"opium of the people\" — it promises rewards in the afterlife and tells the poor to accept their suffering, keeping them docile and obedient."
            },
            {
              "label": "Religion provides moral guidance and social solidarity",
              "col": 1,
              "explanation": "Durkheim argued religion reinforces the collective conscience — shared rituals build social cohesion and remind people of their shared values and belonging."
            }
          ],
    ...
    },
    {
      ...
      "blocks": [
        ...
        },
        {
          ...
          "items": [
            {
              "label": "Inequality is necessary to motivate people into important roles",
              "col": 1,
              "explanation": "Davis and Moore (Functionalist) argued that higher rewards for important jobs motivate the most talented people to fill them. Inequality is functional."
            },
            {
              "label": "The working class are prevented from realising their own exploitation",
              "col": 0,
              "explanation": "Marx's concept of \"false consciousness\" — workers don't revolt because ruling-class ideology has convinced them the system is fair."
            },
            {
              "label": "Every society needs a shared set of values to survive",
              "col": 1,
              "explanation": "Durkheim's \"collective conscience\" — the shared moral values that bind society together. Without them, society falls apart."
            },
            {
              "label": "Capitalism cannot be reformed — it must be overthrown",
              "col": 0,
              "explanation": "Marx believed capitalism was too fundamentally exploitative to be fixed. Only revolution and a communist society would end exploitation."
            },
            {
              "label": "Social change should be gradual and evolutionary, not revolutionary",
              "col": 1,
              "explanation": "Functionalists see society as naturally self-regulating. Change happens slowly as society adapts — sudden revolution is dangerous and destabilising."
            },
            {
              "label": "The ruling class shapes the ideas of the whole society to serve its interests",
              "col": 0,
              "explanation": "This is Marx's concept of ideology — the ruling class controls not just the economy, but also the dominant ideas, values and beliefs of society."
            }
          ],
        ...
        },
        {
          ...
          "options": [
            {
              "text": "Because some jobs are more important to society and require more skill and training",
              "correct": true
            },
            {
              "text": "Because the ruling class controls wages and keeps workers poor on purpose",
              "correct": false
            },
            {
              "text": "Because capitalism is designed to exploit the working class",
              "correct": false
            },
            {
              "text": "Because the government sets pay levels to benefit powerful groups",
              "correct": false
            }
          ],
