...
export const REVIEW_ENTRIES = [
  ...
  },
  {
    ...
    usage: 'Not routed in ModulePlayer and not referenced by content yet. Review variants expose direct exploration, prediction-before-test and a closed starting state.',
