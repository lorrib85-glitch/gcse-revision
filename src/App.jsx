...
export default function App() {
  ...
  if (view === 'home') return <Home progress={progress} onStart={startSession} />
  if (view === 'session' && session) return <Session session={session} topicId={topicId} onFinish={finishSession} onHome={goHome} />
        ...
        <div className="container">
          ...
          {nextTopic && (
            <div className="fade-up">
              <button className="btn btn-red btn-lg" onClick={() => onStart(nextId)}>Start today's session →</button>
      ...
      {allFlipped && !quizDone && (
        <div className="fade-up">
          ...
          {selected !== null && selected !== card.quiz.correctIndex && (
            <div className="feedback wrong fade-up mt-12">
