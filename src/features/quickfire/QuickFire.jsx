...
const QUICK_FIRE_HANDWRITTEN_QUESTIONS = [
  ...
  { q: 'What did Lister use as an antiseptic?', options: ['Carbolic acid', 'Penicillin', 'Ether', 'Aspirin'], correct: 0, subject: 'History', topic: 'Surgery & Anatomy', moduleId: 'history-medicine-surgery-anaesthetics', ms: 'Joseph Lister used carbolic acid to reduce infection in surgery.', hint: 'This chemical was already used to treat sewage before Lister sprayed it on wounds and instruments.' },
  { q: 'Who discovered penicillin?', options: ['Alexander Fleming', 'Robert Koch', 'James Simpson', 'John Snow'], correct: 0, subject: 'History', topic: 'Modern Medicine', moduleId: 'history-medicine-accidental-miracle', ms: 'Alexander Fleming discovered penicillin in 1928.', hint: 'He noticed a mould had killed the bacteria growing around it on a petri dish he had left out.' },
  { q: 'What did John Snow remove in 1854?', options: ['A pump handle', 'A hospital ward', 'A sewer pipe', 'A microscope lens'], correct: 0, subject: 'History', topic: 'Public Health', moduleId: 'history-medicine-great-stink', ms: 'John Snow removed the Broad Street pump handle during a cholera outbreak.', hint: 'He mapped cholera deaths around Broad Street and traced them back to a contaminated water source.' },
  { q: 'Which war helped plastic surgery develop?', options: ['First World War', 'Crimean War', 'Vietnam War', 'English Civil War'], correct: 0, subject: 'History', topic: 'Modern Surgery', moduleId: 'history-medicine-surgery-anaesthetics', ms: 'The First World War created a need for reconstructive plastic surgery.', hint: 'Trench warfare caused huge numbers of severe facial injuries that needed reconstruction.' },
