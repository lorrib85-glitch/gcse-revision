...
export const QUICK_QUIZ_QUESTIONS = [
  ...
  //
  // CANONICAL SOURCE: the audited curation workbook
  // (gcse-question-curation-workbook-history-medicine-v3-AUDITED). Rows that
  // passed the audit are synced from it and carry canonical metadata
  // (learningStage, difficultyLevel, primaryConcept, secondaryConcepts,
  // followUpConcept, acceptedAnswers, tags). App-native routing fields (tag,
  // topic, subject) and the student `reasoning` hint are preserved, not synced.
  // Excluded (not synced): qq_h27, qq_h50, qq_h53, qq_h54 — retire candidates /
  // unresolved concept issues; left untouched pending a human decision.
  // Guarded by tests/architecture/quickfire-workbook-sync.test.js.
  // ════════════════════════════════════════════════════════
...

  {
    ...
    difficulty: 'easy', difficultyLevel: 2, type: 'mcq',
    question: 'What were the medieval explanations for disease?',
    options: ['God, miasma, astrology and the Four Humours', 'Witchcraft, curses and evil spirits', 'Cold weather, hard work and a poor diet', 'An imbalance of salt, sugar and acid in the body'],
    correctIndex: 0,
    explanation: 'Medieval explanations included supernatural ideas such as God/sin, natural ideas such as miasma, astrology, and the Four Humours.',
    ...
    misconception: 'Thinking medieval people had only one explanation for disease.',
    learningStage: 'understand',
    primaryConcept: 'history:medicine:god-punishment',
    secondaryConcepts: ['history:medicine:four-humours', 'history:medicine:miasma', 'history:medicine:astrology'],
    followUpConcept: 'history:medicine:four-humours',
    tags: ['history:medicine:god-punishment', 'history:medicine:four-humours', 'history:medicine:miasma', 'history:medicine:astrology'],
    source: '90s quiz audit',
  },

  {
    id: 'qq_h2', subject: 'History', topic: 'Medieval Medicine', tag: 'four-humours',
    difficulty: 'medium', difficultyLevel: 2, type: 'mcq',
    question: 'What was the Theory of the Four Humours?',
    options: ['The idea that illness came from an imbalance of body fluids', 'The idea that disease was caused by germs', 'The idea that illness was always caused by sin', 'The idea that surgery could cure all disease'],
    correctIndex: 0,
    explanation: 'The Four Humours theory said health depended on balancing blood, phlegm, yellow bile and black bile.',
    reasoning: 'Based on Hippocrates and developed by Galen, this theory dominated medicine for over 1,400 years.',
    misconception: 'Confusing Four Humours with miasma or germ theory.',
    learningStage: 'understand',
    primaryConcept: 'history:medicine:four-humours',
    secondaryConcepts: ['history:medicine:hippocrates', 'history:medicine:galen'],
    followUpConcept: 'history:medicine:bloodletting',
    tags: ['history:medicine:four-humours', 'history:medicine:hippocrates', 'history:medicine:galen'],
    source: '90s quiz audit',
  },

  {
    id: 'qq_h3', subject: 'History', topic: 'Medieval Medicine', tag: 'miasma',
    difficulty: 'easy', difficultyLevel: 1, type: 'truefalse',
    question: 'Miasma Theory was the belief that disease was caused by bad air.',
    correct: true,
    explanation: 'Miasma theory claimed that bad smells or bad air caused disease.',
    ...
    misconception: 'Confusing miasma with germs.',
    acceptedAnswers: ['true', 'yes'],
    learningStage: 'recognise',
    primaryConcept: 'history:medicine:miasma',
    secondaryConcepts: [],
    followUpConcept: 'history:medicine:john-snow',
    tags: ['history:medicine:miasma'],
    source: '90s quiz audit',
  },

  {
    id: 'qq_h4', subject: 'History', topic: 'Medieval Medicine', tag: 'galen',
    difficulty: 'hard', difficultyLevel: 4, type: 'mcq',
    question: 'Why did Galen remain influential for over 1,400 years?',
    options: ['His ideas were supported by the Church and taught in universities', 'He discovered penicillin', 'He proved germ theory', 'He founded the NHS'],
    correctIndex: 0,
    explanation: 'Galen remained influential because his ideas fitted Christian teaching, were preserved by the Church and became central to medical training.',
    ...
    misconception: 'Thinking Galen stayed influential because his ideas were scientifically proven.',
    learningStage: 'analyse',
    primaryConcept: 'history:medicine:galen',
    secondaryConcepts: ['history:medicine:church-authority'],
    followUpConcept: 'history:medicine:four-humours',
    tags: ['history:medicine:galen', 'history:medicine:church-authority'],
    source: '90s quiz audit',
  },

  {
    ...
    options: ['To rebalance the Four Humours', 'To release harmful spirits or demons from the body', 'To weaken the illness by removing what fed it', 'To examine the blood for signs of disease'],
    correctIndex: 0,
    explanation: 'Bloodletting was used because doctors believed removing blood could restore balance between the Four Humours.',
    ...
    misconception: 'Thinking bloodletting was based on germ theory.',
    learningStage: 'understand',
    primaryConcept: 'history:medicine:bloodletting',
    secondaryConcepts: ['history:medicine:four-humours'],
    followUpConcept: 'history:medicine:galen',
    tags: ['history:medicine:bloodletting', 'history:medicine:four-humours'],
    source: '90s quiz audit',
  },

  {
    ...
    options: ['Prayer, avoiding bad air, cleanliness and balancing humours', 'Bloodletting, purging and herbal remedies for the sick', 'Boiling drinking water and washing hands with soap', 'Casting spells and wearing magic amulets'],
    correctIndex: 0,
    explanation: 'Medieval prevention could include religious actions, avoiding miasma, keeping clean and trying to balance the humours.',
    reasoning: 'Since disease was blamed on God and bad air, prevention focused on pleasing God and avoiding bad smells.',
    misconception: 'Only remembering prayer and missing natural prevention methods.',
    learningStage: 'understand',
    primaryConcept: 'history:medicine:prayer',
    secondaryConcepts: ['history:medicine:pilgrimage', 'history:medicine:miasma'],
    followUpConcept: 'history:medicine:miasma',
    tags: ['history:medicine:prayer', 'history:medicine:pilgrimage', 'history:medicine:miasma'],
    source: '90s quiz audit',
  },

  {
    id: 'qq_h7', subject: 'History', topic: 'Medieval Medicine', tag: 'medieval-practitioners',
    difficulty: 'medium', difficultyLevel: 3, type: 'mcq',
    question: 'What did physicians, apothecaries and barber-surgeons each do?',
    options: ['Physicians diagnosed, apothecaries mixed remedies, barber-surgeons did basic surgery', 'Physicians built hospitals, apothecaries ran churches, barber-surgeons made vaccines', 'All three performed the same role', 'They were modern NHS doctors'],
    correctIndex: 0,
    explanation: 'Medieval medical practitioners had different roles: physicians diagnosed, apothecaries prepared remedies, and barber-surgeons carried out practical procedures.',
    reasoning: 'Most people could only afford barber-surgeons. Physicians were expensive and for the wealthy.',
    misconception: 'Mixing up physicians, apothecaries and barber-surgeons.',
    learningStage: 'understand',
    primaryConcept: 'history:medicine:physicians',
    secondaryConcepts: ['history:medicine:apothecaries', 'history:medicine:barber-surgeons'],
    followUpConcept: 'history:medicine:medieval-hospitals',
    tags: ['history:medicine:physicians', 'history:medicine:apothecaries', 'history:medicine:barber-surgeons'],
    source: '90s quiz audit',
  },

  {
    id: 'qq_h8', subject: 'History', topic: 'Medieval Medicine', tag: 'black-death',
    difficulty: 'hard', difficultyLevel: 3, type: 'mcq',
    question: 'How did people respond to the Black Death in 1348?',
    options: ['Prayer, flagellation, quarantine, cleaning streets and avoiding bad air', 'Bloodletting and herbal remedies alone, with no religious or communal action', 'Relying only on magic charms and spells to keep safe', 'Ignoring the outbreak because they believed it was harmless'],
    correctIndex: 0,
    explanation: 'Responses to the Black Death reflected medieval beliefs: some religious, some linked to miasma, and some practical public-health measures.',
    ...
    misconception: 'Assuming all responses were religious and ignoring practical measures.',
    learningStage: 'understand',
    primaryConcept: 'history:medicine:black-death',
    secondaryConcepts: ['history:medicine:flagellants', 'history:medicine:god-punishment'],
    followUpConcept: 'history:medicine:miasma',
    tags: ['history:medicine:black-death', 'history:medicine:flagellants', 'history:medicine:god-punishment'],
    source: '90s quiz audit',
  },
...

  {
    ...
    options: ['More observation, dissection, printing and challenge to ancient ideas', 'Germ theory was fully accepted', 'The NHS was created', 'Penicillin became widely used'],
    correctIndex: 0,
    explanation: 'Renaissance medicine saw greater emphasis on observation, human dissection, printed books and challenging Galen\'s authority, although treatments changed slowly.',
    reasoning: 'This shift in method — from "trust Galen" to "test it yourself" — was more important than any single discovery.',
    misconception: 'Thinking Renaissance medicine changed everything immediately.',
    learningStage: 'analyse',
    primaryConcept: 'history:medicine:vesalius',
    secondaryConcepts: ['history:medicine:printing-press', 'history:medicine:harvey'],
    followUpConcept: 'history:medicine:galen',
    tags: ['history:medicine:vesalius', 'history:medicine:printing-press', 'history:medicine:harvey'],
    source: '90s quiz audit',
  },

  {
    id: 'qq_h10', subject: 'History', topic: 'Renaissance Medicine', tag: 'vesalius',
    difficulty: 'exam', difficultyLevel: 4, type: 'mcq',
    question: 'Why was Vesalius important to the development of medicine?',
    options: ['He used human dissection and corrected errors in Galen\'s anatomy', 'He discovered penicillin', 'He founded the NHS', 'He proved cholera came from water'],
    correctIndex: 0,
    explanation: 'Vesalius was important because he used direct observation and human dissection to correct Galen\'s mistakes, helping anatomy become more accurate.',
    ...
    misconception: 'Only saying he was \'important\' without explaining how he challenged Galen.',
    learningStage: 'analyse',
    primaryConcept: 'history:medicine:vesalius',
    secondaryConcepts: ['history:medicine:anatomy', 'history:medicine:dissection'],
    followUpConcept: 'history:medicine:galen',
    tags: ['history:medicine:vesalius', 'history:medicine:anatomy', 'history:medicine:dissection'],
    source: '90s quiz audit',
  },

  {
    ...
    misconception: 'Thinking the printing press made discoveries itself, rather than spreading them faster.',
    learningStage: 'understand',
    primaryConcept: 'history:medicine:printing-press',
    secondaryConcepts: ['history:medicine:vesalius'],
    followUpConcept: 'history:medicine:royal-society',
    tags: ['history:medicine:printing-press', 'history:medicine:vesalius'],
    source: '90s quiz audit',
  },

  {
    ...
    misconception: 'Assuming the Royal Society treated patients rather than promoting research and publication.',
    learningStage: 'understand',
    primaryConcept: 'history:medicine:royal-society',
    secondaryConcepts: [],
    followUpConcept: 'history:medicine:sydenham',
    tags: ['history:medicine:royal-society'],
    source: '90s quiz audit',
  },

  {
    ...
    learningStage: 'analyse',
    primaryConcept: 'history:medicine:harvey',
    secondaryConcepts: [],
    followUpConcept: 'history:medicine:galen',
    tags: ['history:medicine:harvey'],
    source: '90s quiz audit',
  },

  {
    ...
    misconception: 'Assuming responses were based on germ theory rather than miasma and isolation.',
    learningStage: 'understand',
    primaryConcept: 'history:medicine:great-plague',
    secondaryConcepts: ['history:medicine:quarantine'],
    followUpConcept: 'history:medicine:miasma',
    tags: ['history:medicine:great-plague', 'history:medicine:quarantine'],
    source: '90s quiz audit',
  },
...

  {
    ...
    learningStage: 'analyse',
    primaryConcept: 'history:medicine:pasteur',
    secondaryConcepts: ['history:medicine:germ-theory'],
    followUpConcept: 'history:medicine:koch',
    tags: ['history:medicine:pasteur', 'history:medicine:germ-theory'],
    source: '90s quiz audit',
  },

  {
    ...
    learningStage: 'understand',
    primaryConcept: 'history:medicine:nightingale',
    secondaryConcepts: [],
    followUpConcept: 'history:medicine:germ-theory',
    tags: ['history:medicine:nightingale'],
    source: '90s quiz audit',
  },

  {
    ...
    learningStage: 'understand',
    primaryConcept: 'history:medicine:anaesthetics',
    secondaryConcepts: ['history:medicine:chloroform'],
    followUpConcept: 'history:medicine:antiseptics',
    tags: ['history:medicine:anaesthetics', 'history:medicine:chloroform'],
    source: '90s quiz audit',
  },

  {
    ...
    learningStage: 'analyse',
    primaryConcept: 'history:medicine:antiseptics',
    secondaryConcepts: ['history:medicine:lister', 'history:medicine:carbolic-acid'],
    followUpConcept: 'history:medicine:aseptic-surgery',
    tags: ['history:medicine:antiseptics', 'history:medicine:lister', 'history:medicine:carbolic-acid'],
    source: '90s quiz audit',
  },

  {
    ...
    misconception: 'Confusing the compulsory 1875 Act with the voluntary 1848 Act.',
    learningStage: 'understand',
    primaryConcept: 'history:medicine:public-health-act-1875',
    secondaryConcepts: [],
    followUpConcept: 'history:medicine:bazalgette',
    tags: ['history:medicine:public-health-act-1875'],
    source: '90s quiz audit',
  },

  {
    ...
    learningStage: 'understand',
    primaryConcept: 'history:medicine:jenner',
    secondaryConcepts: ['history:medicine:vaccination', 'history:medicine:smallpox'],
    followUpConcept: 'history:medicine:germ-theory',
    tags: ['history:medicine:jenner', 'history:medicine:vaccination', 'history:medicine:smallpox'],
    source: '90s quiz audit',
  },

  {
    ...
    misconception: 'Snow was right about water but did not know about germ theory — it was not proven until 1861.',
    learningStage: 'understand',
    primaryConcept: 'history:medicine:john-snow',
    secondaryConcepts: ['history:medicine:cholera', 'history:medicine:broad-street-pump'],
    followUpConcept: 'history:medicine:germ-theory',
    tags: ['history:medicine:john-snow', 'history:medicine:cholera', 'history:medicine:broad-street-pump'],
    source: '90s quiz audit',
  },

  {
    ...
    misconception: 'Thinking Snow used laboratory or microscope proof rather than mapping cases.',
    learningStage: 'analyse',
    primaryConcept: 'history:medicine:john-snow',
    secondaryConcepts: ['history:medicine:broad-street-pump', 'history:medicine:cholera'],
    followUpConcept: 'history:medicine:public-health-act-1875',
    tags: ['history:medicine:john-snow', 'history:medicine:broad-street-pump', 'history:medicine:cholera'],
    source: '90s quiz audit',
  },

  {
    ...
    misconception: 'Confusing Pasteur\'s germ evidence with Snow\'s cholera mapping or Lister\'s surgery.',
    learningStage: 'understand',
    primaryConcept: 'history:medicine:pasteur',
    secondaryConcepts: ['history:medicine:germ-theory', 'history:medicine:spontaneous-generation'],
    followUpConcept: 'history:medicine:koch',
    tags: ['history:medicine:pasteur', 'history:medicine:germ-theory', 'history:medicine:spontaneous-generation'],
    source: '90s quiz audit',
  },

  {
    ...
    misconception: 'Thinking microbiology let doctors see inside the body, confusing it with imaging.',
    learningStage: 'analyse',
    primaryConcept: 'history:medicine:germ-theory',
    secondaryConcepts: ['history:medicine:koch'],
    followUpConcept: 'history:medicine:magic-bullets',
    tags: ['history:medicine:germ-theory', 'history:medicine:koch'],
    source: '90s quiz audit',
  },
...

  {
    ...
    primaryConcept: 'history:medicine:nhs',
    secondaryConcepts: [],
    followUpConcept: 'history:medicine:penicillin',
    tags: ['history:medicine:nhs'],
    source: '90s quiz audit',
  },

  {
    ...
    misconception: 'Thinking the NHS introduced antibiotics or new treatments rather than free access.',
    learningStage: 'understand',
    primaryConcept: 'history:medicine:nhs',
    secondaryConcepts: [],
    followUpConcept: 'history:medicine:lifestyle-factors',
    tags: ['history:medicine:nhs'],
    source: '90s quiz audit',
  },
...

  {
    ...
    misconception: 'Thinking scans replaced blood tests rather than adding to them.',
    learningStage: 'understand',
    primaryConcept: 'history:medicine:x-rays',
    secondaryConcepts: [],
    followUpConcept: 'history:medicine:blood-transfusion',
    tags: ['history:medicine:x-rays'],
    source: '90s quiz audit',
  },

  {
    id: 'qq_h29', subject: 'History', topic: 'Modern Medicine', tag: 'lifestyle-factors',
    difficulty: 'easy', difficultyLevel: 1, type: 'mcq',
    ...
    misconception: 'Confusing lifestyle factors (personal choices) with environmental or genetic factors.',
    learningStage: 'recall',
    primaryConcept: 'history:medicine:lifestyle-factors',
    secondaryConcepts: [],
    followUpConcept: 'history:medicine:cancer-treatment',
    tags: ['history:medicine:lifestyle-factors'],
    source: '90s quiz audit',
  },

  {
    ...
    misconception: 'Thinking genetics means all diseases are inherited.',
    learningStage: 'understand',
    primaryConcept: 'history:medicine:dna',
    secondaryConcepts: [],
    followUpConcept: 'history:medicine:watson-and-crick',
    tags: ['history:medicine:dna'],
    source: '90s quiz audit',
  },

  {
    ...
    misconception: 'Fleming discovered penicillin but could not develop it — Florey and Chain made it into an effective drug in the 1940s.',
    learningStage: 'understand',
    primaryConcept: 'history:medicine:penicillin',
    secondaryConcepts: ['history:medicine:fleming'],
    followUpConcept: 'history:medicine:florey-and-chain',
    tags: ['history:medicine:penicillin', 'history:medicine:fleming'],
    source: '90s quiz audit',
  },

  {
    ...
    misconception: 'Thinking penicillin targeted cancer or replaced vaccination.',
    learningStage: 'analyse',
    primaryConcept: 'history:medicine:penicillin',
    secondaryConcepts: ['history:medicine:florey-and-chain'],
    followUpConcept: 'history:medicine:magic-bullets',
    tags: ['history:medicine:penicillin', 'history:medicine:florey-and-chain'],
    source: '90s quiz audit',
  },

  {
    ...
    misconception: 'Confusing magic bullets (chemical drugs) with antibiotics or vaccines.',
    learningStage: 'understand',
    primaryConcept: 'history:medicine:magic-bullets',
    secondaryConcepts: ['history:medicine:ehrlich', 'history:medicine:salvarsan-606'],
    followUpConcept: 'history:medicine:penicillin',
    tags: ['history:medicine:magic-bullets', 'history:medicine:ehrlich', 'history:medicine:salvarsan-606'],
    source: '90s quiz audit',
  },

  {
    ...
    misconception: 'Thinking one single advance improved surgery rather than several combined.',
    learningStage: 'analyse',
    primaryConcept: 'history:medicine:anaesthetics',
    secondaryConcepts: ['history:medicine:aseptic-surgery', 'history:medicine:blood-transfusion'],
    followUpConcept: 'history:medicine:x-rays',
    tags: ['history:medicine:anaesthetics', 'history:medicine:aseptic-surgery', 'history:medicine:blood-transfusion'],
    source: '90s quiz audit',
  },

  {
    id: 'qq_h35', subject: 'History', topic: 'Modern Medicine', tag: 'war-and-medicine',
    difficulty: 'hard', difficultyLevel: 5, type: 'mcq',
    ...
    misconception: 'Thinking war only harmed medicine, or that progress came from experimenting on patients.',
    learningStage: 'evaluate',
    primaryConcept: 'history:medicine:chain-of-evacuation',
    secondaryConcepts: ['history:medicine:blood-transfusion', 'history:medicine:plastic-surgery'],
    followUpConcept: 'history:medicine:penicillin',
    tags: ['history:medicine:chain-of-evacuation', 'history:medicine:blood-transfusion', 'history:medicine:plastic-surgery'],
    source: '90s quiz audit',
  },

  {
    ...
    misconception: 'Thinking communication helps patients rather than the spread of discoveries.',
    learningStage: 'understand',
    primaryConcept: 'history:medicine:factors-in-change',
    secondaryConcepts: ['history:medicine:printing-press'],
    followUpConcept: 'history:medicine:royal-society',
    tags: ['history:medicine:factors-in-change', 'history:medicine:printing-press'],
    source: '90s quiz audit',
  },

  {
    ...
    misconception: 'Thinking medieval hospitals performed surgery or trained doctors.',
    learningStage: 'understand',
    primaryConcept: 'history:medicine:medieval-hospitals',
    secondaryConcepts: ['history:medicine:religion'],
    followUpConcept: 'history:medicine:physicians',
    tags: ['history:medicine:medieval-hospitals', 'history:medicine:religion'],
    source: '90s quiz audit',
  },

  {
    ...
    misconception: 'Blaming doctors\' attitudes rather than the incorrect underlying theory.',
    learningStage: 'analyse',
    primaryConcept: 'history:medicine:four-humours',
    secondaryConcepts: ['history:medicine:miasma'],
    followUpConcept: 'history:medicine:germ-theory',
    tags: ['history:medicine:four-humours', 'history:medicine:miasma'],
    source: '90s quiz audit',
  },

  {
    ...
    misconception: 'Confusing Renaissance anatomy with the later discovery of bacteria.',
    learningStage: 'understand',
    primaryConcept: 'history:medicine:vesalius',
    secondaryConcepts: [],
    followUpConcept: 'history:medicine:harvey',
    tags: ['history:medicine:vesalius'],
    source: '90s quiz audit',
  },

  {
    ...
    options: ['All hospitals immediately banned bloodletting and humour treatments', 'Scientists began identifying the specific microbes that cause disease', 'Britain\'s sewers and sanitation reforms began for the very first time', 'Antibiotics were invented to replace older treatments'],
    correctIndex: 1,
    explanation: 'Once Germ Theory was accepted, scientists such as Koch set out to identify the specific microbe causing each disease, and later to develop vaccines and antitoxins. (Britain\'s major sanitation reforms, e.g. Bazalgette\'s sewers and the 1875 Public Health Act, came earlier and were driven mainly by the sanitary/anti-miasma movement, not by Germ Theory — which later helped explain why cleanliness worked.)',
    ...
    misconception: 'Thinking Germ Theory caused Britain\'s earlier sanitation and public-health reforms. In fact sewers and the 1875 Act came first, driven by the sanitary/anti-miasma movement; Germ Theory later explained why they worked.',
    learningStage: 'understand',
    primaryConcept: 'history:medicine:germ-theory',
    secondaryConcepts: ['history:medicine:koch'],
    followUpConcept: 'history:medicine:koch',
...

  {
    ...
    misconception: 'Thinking it proved cholera spread by bad air, or triggered the 1848 Act.',
    learningStage: 'analyse',
    primaryConcept: 'history:medicine:broad-street-pump',
    secondaryConcepts: ['history:medicine:john-snow', 'history:medicine:cholera'],
    followUpConcept: 'history:medicine:germ-theory',
    tags: ['history:medicine:broad-street-pump', 'history:medicine:john-snow', 'history:medicine:cholera'],
    source: '90s quiz audit',
  },

  {
    ...
    misconception: 'Thinking vaccination kills an existing infection rather than preventing one.',
    learningStage: 'recall',
    primaryConcept: 'history:medicine:vaccination',
    secondaryConcepts: [],
    followUpConcept: 'history:medicine:jenner',
    tags: ['history:medicine:vaccination'],
    source: '90s quiz audit',
  },

  {
    ...
    misconception: 'Crediting new medicines rather than sewers and clean water.',
    learningStage: 'understand',
    primaryConcept: 'history:medicine:bazalgette',
    secondaryConcepts: ['history:medicine:public-health-act-1875'],
    followUpConcept: 'history:medicine:cholera',
    tags: ['history:medicine:bazalgette', 'history:medicine:public-health-act-1875'],
    source: '90s quiz audit',
  },

  {
    ...
    options: ['Only because carbolic acid was too costly for hospitals to buy', 'Because the government had made antiseptic surgery illegal', 'Carbolic acid irritated skin and lungs and slowed surgery, and some were reluctant to change', 'Because they thought anaesthetics were more important to develop first'],
    correctIndex: 2,
    explanation: 'Resistance was multi-causal. Lister\'s carbolic acid spray irritated surgeons\' skin and lungs, cracked and dried the hands, made instruments slippery and slowed operations; early results were also inconsistent and some surgeons did not yet accept germ theory. Alongside these practical objections, experienced surgeons could be reluctant to abandon established methods.',
    ...
    misconception: 'Assuming resistance had a single cause. It was neither pure stubbornness nor simply cost: practical drawbacks (skin/lung irritation, cracked hands, fumes, slower surgery, inconsistent early results) combined with reluctance to change and incomplete acceptance of germ theory.',
    learningStage: 'analyse',
    primaryConcept: 'history:medicine:antiseptics',
    secondaryConcepts: ['history:medicine:lister'],
    followUpConcept: 'history:medicine:aseptic-surgery',
    tags: ['history:medicine:antiseptics', 'history:medicine:lister'],
    source: '90s quiz audit',
  },

  {
    ...
    misconception: 'Confusing triage (prioritising) with transporting or treating wounds.',
    learningStage: 'recall',
    primaryConcept: 'history:medicine:chain-of-evacuation',
    secondaryConcepts: [],
    followUpConcept: 'history:medicine:casualty-clearing-stations',
    tags: ['history:medicine:chain-of-evacuation'],
    source: '90s quiz audit',
  },

  {
    ...
    misconception: 'Thinking WWI produced penicillin or founded the NHS.',
    learningStage: 'analyse',
    primaryConcept: 'history:medicine:blood-transfusion',
    secondaryConcepts: ['history:medicine:x-rays', 'history:medicine:plastic-surgery', 'history:medicine:thomas-splint'],
    followUpConcept: 'history:medicine:chain-of-evacuation',
    tags: ['history:medicine:blood-transfusion', 'history:medicine:x-rays', 'history:medicine:plastic-surgery', 'history:medicine:thomas-splint'],
    source: '90s quiz audit',
  },

  {
    ...
    misconception: 'Confusing Koch with Fleming (penicillin) or Harvey (circulation).',
    learningStage: 'analyse',
    primaryConcept: 'history:medicine:koch',
    secondaryConcepts: ['history:medicine:germ-theory'],
    followUpConcept: 'history:medicine:pasteur',
    tags: ['history:medicine:koch', 'history:medicine:germ-theory'],
    source: '90s quiz audit',
  },

  {
    ...
    misconception: 'Confusing Simpson (chloroform) with Jenner (vaccination) or Lister (antiseptics).',
    learningStage: 'understand',
    primaryConcept: 'history:medicine:simpson',
    secondaryConcepts: ['history:medicine:chloroform', 'history:medicine:anaesthetics'],
    followUpConcept: 'history:medicine:antiseptics',
    tags: ['history:medicine:simpson', 'history:medicine:chloroform', 'history:medicine:anaesthetics'],
    source: '90s quiz audit',
  },

  {
    id: 'qq_h49', subject: 'History', topic: 'Modern Medicine', tag: 'factors-in-change',
    difficulty: 'exam', difficultyLevel: 5, type: 'mcq',
    ...
    misconception: 'Thinking progress was driven mainly by individual genius or was sudden.',
    learningStage: 'evaluate',
    primaryConcept: 'history:medicine:factors-in-change',
    secondaryConcepts: [],
    followUpConcept: 'history:medicine:pasteur',
    tags: ['history:medicine:factors-in-change'],
    source: '90s quiz audit',
  },
...

  {
    ...
    misconception: 'Confusing Sydenham with those who disproved humoural theory outright.',
    learningStage: 'understand',
    primaryConcept: 'history:medicine:sydenham',
    secondaryConcepts: [],
    followUpConcept: 'history:medicine:royal-society',
    tags: ['history:medicine:sydenham'],
    source: '90s quiz audit',
  },

  {
    ...
    misconception: 'Confusing Sydenham with the Royal Society founders or a malaria treatment.',
    learningStage: 'analyse',
    primaryConcept: 'history:medicine:sydenham',
    secondaryConcepts: [],
    followUpConcept: 'history:medicine:hippocrates',
    tags: ['history:medicine:sydenham'],
    source: '90s quiz audit',
  },
...

  {
    ...
    misconception: 'Koch did not disprove Pasteur — he extended and proved germ theory.',
    learningStage: 'analyse',
    primaryConcept: 'history:medicine:koch',
    secondaryConcepts: ['history:medicine:germ-theory'],
    followUpConcept: 'history:medicine:pasteur',
...

  {
    ...
    difficulty: 'exam', difficultyLevel: 3, type: 'truefalse',
    ...
    misconception: 'Thinking one germ causes many diseases.',
    acceptedAnswers: ['false', 'no'],
    learningStage: 'understand',
    primaryConcept: 'history:medicine:koch',
    secondaryConcepts: [],
    followUpConcept: 'history:medicine:germ-theory',
    tags: ['history:medicine:koch'],
    source: '90s quiz audit',
  },

  {
    ...
    misconception: 'Thinking Koch invented the microscope or corrected Pasteur’s errors.',
    learningStage: 'analyse',
    primaryConcept: 'history:medicine:koch',
    secondaryConcepts: ['history:medicine:germ-theory'],
    followUpConcept: 'history:medicine:pasteur',
...

  {
    ...
    difficulty: 'hard', difficultyLevel: 2, type: 'mcq',
    ...
    misconception: 'Misreading 606 as a patient number rather than the 606th compound tested.',
    learningStage: 'recall',
    primaryConcept: 'history:medicine:salvarsan-606',
    secondaryConcepts: ['history:medicine:ehrlich', 'history:medicine:magic-bullets'],
    followUpConcept: 'history:medicine:penicillin',
    tags: ['history:medicine:salvarsan-606', 'history:medicine:ehrlich', 'history:medicine:magic-bullets'],
    source: '90s quiz audit',
  },

  {
    ...
    misconception: 'Thinking magic bullets made vaccination unnecessary.',
    learningStage: 'analyse',
    primaryConcept: 'history:medicine:magic-bullets',
    secondaryConcepts: ['history:medicine:ehrlich'],
    followUpConcept: 'history:medicine:penicillin',
    tags: ['history:medicine:magic-bullets', 'history:medicine:ehrlich'],
    source: '90s quiz audit',
  },

  {
    ...
    misconception: 'Thinking gas or cold were the main killers rather than infection and wounds.',
    learningStage: 'understand',
    primaryConcept: 'history:medicine:wound-infection',
    secondaryConcepts: ['history:medicine:trench-system'],
    followUpConcept: 'history:medicine:chain-of-evacuation',
    tags: ['history:medicine:wound-infection', 'history:medicine:trench-system'],
    source: '90s quiz audit',
  },

  {
    id: 'qq_h61', subject: 'History', topic: 'Modern Medicine', tag: 'wwi-medicine',
    difficulty: 'exam', difficultyLevel: 2, type: 'mcq',
    ...
    misconception: 'Confusing the Chain of Evacuation with a supply line or civilian evacuation.',
    learningStage: 'recall',
    primaryConcept: 'history:medicine:chain-of-evacuation',
    secondaryConcepts: ['history:medicine:casualty-clearing-stations'],
    followUpConcept: 'history:medicine:ramc',
    tags: ['history:medicine:chain-of-evacuation', 'history:medicine:casualty-clearing-stations'],
    source: '90s quiz audit',
  },

  {
    ...
    misconception: 'Thinking the Chain existed to keep doctors safe or to reduce costs.',
    learningStage: 'analyse',
    primaryConcept: 'history:medicine:chain-of-evacuation',
    secondaryConcepts: [],
    followUpConcept: 'history:medicine:casualty-clearing-stations',
...

  {
    ...
    misconception: 'Thinking X-rays sterilised wounds or diagnosed shell shock.',
    learningStage: 'understand',
    primaryConcept: 'history:medicine:x-rays',
    secondaryConcepts: [],
    followUpConcept: 'history:medicine:blood-transfusion',
...

  {
    ...
    misconception: 'Confusing Gillies with the discovery of blood types or the Chain of Evacuation.',
    learningStage: 'analyse',
    primaryConcept: 'history:medicine:plastic-surgery',
    secondaryConcepts: [],
    followUpConcept: 'history:medicine:blood-transfusion',
    tags: ['history:medicine:plastic-surgery'],
    source: '90s quiz audit',
  },

  {
    id: 'qq_h65', subject: 'History', topic: 'Modern Medicine', tag: 'wwi-medicine',
    difficulty: 'exam', difficultyLevel: 3, type: 'mcq',
    ...
    misconception: 'Confusing the splint with a stretcher or a surgical instrument.',
    learningStage: 'understand',
    primaryConcept: 'history:medicine:thomas-splint',
    secondaryConcepts: [],
    followUpConcept: 'history:medicine:chain-of-evacuation',
    tags: ['history:medicine:thomas-splint'],
    source: '90s quiz audit',
  },

  {
    ...
    misconception: 'Thinking transfusion replaced anaesthetics or antiseptics.',
    learningStage: 'understand',
    primaryConcept: 'history:medicine:blood-transfusion',
    secondaryConcepts: ['history:medicine:blood-banks'],
    followUpConcept: 'history:medicine:blood-banks',
    tags: ['history:medicine:blood-transfusion', 'history:medicine:blood-banks'],
    source: '90s quiz audit',
  },

  {
    ...
    misconception: 'Thinking genetics alone, not lifestyle, causes lung cancer.',
    learningStage: 'analyse',
    primaryConcept: 'history:medicine:lifestyle-factors',
    secondaryConcepts: ['history:medicine:cancer-treatment'],
    followUpConcept: 'history:medicine:cancer-treatment',
    tags: ['history:medicine:lifestyle-factors', 'history:medicine:cancer-treatment'],
    source: '90s quiz audit',
  },

  {
    ...
    misconception: 'Thinking DNA knowledge means all disease is inherited or surgery is obsolete.',
    learningStage: 'understand',
    primaryConcept: 'history:medicine:dna',
    secondaryConcepts: ['history:medicine:watson-and-crick'],
    followUpConcept: 'history:medicine:cancer-treatment',
    tags: ['history:medicine:dna', 'history:medicine:watson-and-crick'],
    source: '90s quiz audit',
  },

  {
    ...
    misconception: 'Confusing the Genome Project with gene therapy or population screening.',
    learningStage: 'recall',
    primaryConcept: 'history:medicine:dna',
    secondaryConcepts: [],
    followUpConcept: 'history:medicine:watson-and-crick',
...

  {
    ...
    misconception: 'Crediting a single factor rather than the interaction of several.',
    learningStage: 'evaluate',
    primaryConcept: 'history:medicine:factors-in-change',
    secondaryConcepts: [],
    followUpConcept: 'history:medicine:pasteur',
