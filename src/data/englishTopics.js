    ...
    questions: [
      {
        ...
        extract: `SOURCE: Life of Pi by Yann Martel (novel extract — middle section)\n\nThe whole source describes Pi, a boy who is trapped on a lifeboat in the Pacific Ocean. He is sharing the boat with dangerous animals including a spotted hyena, a zebra, an orangutan, and a Bengal tiger called Richard Parker. Pi narrates his observations of the hyena, describing its dangerous nature, its behaviour on the boat, and how the situation unfolds. The source moves from Pi's prior knowledge of hyenas to the immediate threat they pose aboard the lifeboat.`,
      ...
      },
      {
        ...
        extract: `SOURCE: The Pearl by John Steinbeck (novel extract — opening section)\n\nThe whole source is set in a brush house in Mexico where Kino, his wife Juana, and their baby Coyotito live. The source opens peacefully with morning sunlight entering the house. A scorpion is seen moving slowly down a rope towards the baby's hanging bed-box. Kino attempts to catch it and fails. The scorpion stings the baby. Juana immediately attempts to suck the poison from the wound. Kino senses a threat through what Steinbeck calls 'the Song of Evil'. The family rush to find a doctor to treat the baby.`,
    ...
    questions: [
      {
        ...
        extract: `SOURCE: Life of Pi by Yann Martel\nFocus: second part of the source (from line 20 to the end)\n\nIn this section Pi describes the hyena's increasingly wild and frantic behaviour aboard the lifeboat. The hyena paces, circles, and acts erratically. Pi observes it from a distance. The tension builds as the hyena's behaviour becomes more unpredictable, before the situation unexpectedly settles. This section raises the question of how much of a real threat the hyena is to Pi.`,
      ...
      },
      {
        ...
        extract: `SOURCE: The Pearl by John Steinbeck\nFocus: second part of the source (from line 19 to the end)\n\nThis section shows the immediate reactions of Kino and Juana after the scorpion stings their baby Coyotito. Juana is described with a lioness-like determination and takes direct action. Kino displays primal, animal-like rage. The couple rush to find a doctor in the town. Steinbeck uses animal imagery and song motifs to contrast their different responses to the threat facing their child.`,
      ...
      },
      {
        ...
        extract: `SOURCE A: Travel writing from the 1920s by a bored, experienced traveller on a long train journey lasting over a week. He describes the monotony, the facilities, and a train crash he experiences. His tone is sardonic and weary.\n\nSOURCE B: A private letter written in 1830 by Fanny Kemble, one of the first passengers to experience steam train travel. She describes the experience with wonder, excitement and almost disbelief at the speed and novelty of the technology.\n\nCompare how BOTH writers convey their different feelings and perspectives about train travel.`,
      ...
      },
      {
        ...
        extract: `SOURCE A: Personal writing about a miserable family camping holiday to France. The writer (a teenager at the time) describes the journey, the overcrowded and muddy campsite, a violent rainstorm, and the general misery of the holiday. The tone is ironic and humorous.\n\nSOURCE B: A piece of writing by someone who genuinely loves camping. They describe the beauty of nature, the freedom of outdoor life, and the joy of staying in a well-situated campsite. The tone is enthusiastic and celebratory.\n\nCompare how BOTH writers convey their different thoughts and feelings about camping experiences.`,
