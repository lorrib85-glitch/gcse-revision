...
export const ENGLISH_TOPIC_GROUPS = [

  {
    ...
    icon: 'Q1',
    color: '#6A343D',
    bg: 'rgba(106,52,61,.12)',
    border: 'rgba(106,52,61,.28)',
    ...
    questions: [
      ...
      },
      {
        ...
        options: [
          ...
          'F - The writer feels cut off from society while on the train.',
          'G - The writer has had many activities to keep him busy.',
          'H - The writer has no plans for when he leaves the train.',
        ],
        correctIndices: [1, 3, 5, 7],
        ms: 'TRUE: B, D, F, H\n\nA=FALSE (near END of journey) B=TRUE (looking forward to leaving) C=FALSE (not three more days) D=TRUE (dining car) E=FALSE (bread not delicious) F=TRUE (cut off from society) G=FALSE (little to do) H=TRUE (no plans after)\n\n1 mark per correct letter up to 4.',
      },
      {
        ...
        options: [
          ...
          'H - The writer admits holidays can look attractive but thinks this is a trick.',
        ],
        correctIndices: [0, 3, 4, 7],
        ms: "TRUE: A, D, E, H\n\nA=TRUE (mother happy) B=FALSE (been before) C=FALSE (not evil powers) D=TRUE (mental and physical challenges) E=TRUE (teenager) F=FALSE (countryside not city) G=FALSE (sunflowers not wheat) H=TRUE (attractive but a trick)\n\n1 mark per correct letter up to 4.",
      },
    ],
  },

  {
    ...
    bg: 'rgba(106,52,61,.12)',
    border: 'rgba(106,52,61,.28)',
    description: 'P1 Q2 (8 marks): How does the writer use language here? Analyse words, phrases, language features and sentence forms. P2 Q2 (8 marks): Summarise differences between two texts.',
    paper: 'Both papers',
    marks: 8,
    skillTip: 'The formula: QUOTE -> TECHNIQUE (name it) -> EFFECT (what it makes the reader think/feel) -> DEEPER MEANING (why the writer chose it). Always embed quotes. Never just "the writer uses adjectives."',
    levelDescriptors: {
    ...
    questions: [
      ...
      },
      {
        ...
        extract: 'Source A -- The Pearl by John Steinbeck (your insert booklet, lines 7-17)\n\nThis extract was not reproduced in the question paper due to copyright. Refer to your source insert and read lines 7 to 17 carefully before answering.',
      ...
      },
      {
        ...
        ms: 'Level 4 (7-8): Perceptive synthesis. Makes perceptive inferences from both texts; judicious textual detail; shows perceptive differences between texts.\nExample of L4: "The train in Source A has been built to transport both mail and people across long distances, indicating how train travel had become commercialised by the 1920s. This sophistication contrasts sharply with Source B, where the train is just a functional uncovered carriage with benches, reflecting the earliest stage of rail development."\n\nLevel 3 (5-6): Clear synthesis from both texts; clear inferences; clear differences identified.\nLevel 2 (3-4): Some interpretation from one/both texts; some differences noted.\nLevel 1 (1-2): Simple paraphrase from one/both texts; simple differences.\n\nAreas to compare:\n* Size (Source A: large multi-carriage; Source B: little engine and one carriage)\n* Facilities (Source A: dining car, sleeping cars; Source B: uncovered carriage with benches)\n* Purpose (Source A: commercial passenger + mail; Source B: experimental)\n* Stage of development (Source A: 1920s maturity; Source B: 1830s very first trains)',
      },
      {
        id: 'el_p2j22_q2', source: 'P2 JUN22', marks: 8, type: 'written',
        extract: 'Source A -- Camping holiday writing (your insert booklet, whole source)\nSource B -- Writing about a positive camping experience (your insert booklet)\n\nRefer to BOTH sources in your insert. Use details from both to summarise the differences between the two campsites.',
        ...
        ms: 'Level 4 (7-8): Perceptive synthesis from both texts with judicious textual detail; perceptive differences between the two sites.\n\nLevel 3 (5-6): Clear synthesis; clear inferences from both texts; clear differences identified.\nExample of L3: "The campsite in Source A is chaotic and unpleasant -- flooded and crowded, suggesting a lack of comfort. In contrast, the campsite in Source B is peaceful and natural, with beautiful surroundings suggesting freedom and tranquillity."\n\nLevel 2 (3-4): Some interpretation; some references from one or both texts.\nLevel 1 (1-2): Simple paraphrase.\n\nAreas to compare:\n* Conditions (Source A: muddy, flooded, chaotic; Source B: peaceful, natural, beautiful)\n* Facilities (Source A: poor; Source B: good)\n* Atmosphere (Source A: miserable; Source B: free, joyful)\n* Writers feelings (Source A: negative; Source B: positive)',
      },
    ],
  },
    ...
    questions: [
      {
        ...
        extract: 'Source A -- Life of Pi by Yann Martel (your insert booklet -- whole source)\n\nThis question asks you to think about the whole source. Re-read the entire source from your insert booklet before answering.',
        ...
        ms: 'Level 4 (7-8): Perceptive, detailed understanding of structural features.\nExample of L4: "The writer opens by establishing Pi as anxious, rooted in his father\'s warnings about hyenas -- this creates an atmosphere of expected threat. The narrator then presents the power imbalance, signalling imminent danger. However, by the end the threat diminishes as the hyena did not move, creating a structure that builds to an anticlimactic but unsettling resolution."\n\nLevel 3 (5-6): Clear understanding of structural choices and effects.\nLevel 2 (3-4): Some comment on structural features with some examples.\nLevel 1 (1-2): Simple comment on structure.\n\nStructural features to discuss:\n* Opening focus on Pi\'s worry -- establishes anxious tone immediately\n* Shift from description to action\n* Pacing: tension builds, then unexpectedly dissipates\n* Ending with did not move -- unresolved threat',
      },
      {
        id: 'el_p1j22_q3', source: 'P1 JUN22', marks: 8, type: 'written',
        extract: 'Source A -- The Pearl by John Steinbeck (your insert booklet -- whole source)\n\nThis question asks you to think about the whole source. Re-read the entire source from your insert booklet before answering.',
      ...
      },
      {
        ...
        ms: 'Level 4 (10-12): Detailed, perceptive understanding of language.\nExample of L4: "The writer uses hyperbole -- my heaviest suitcase was cannonaded down -- the military verb cannonaded suggests the crash turned his own luggage into a weapon against him. This dramatic escalation is then undercut by the wry calm tone afterwards (I felt very much annoyed), creating a darkly comic structure."\n\nLevel 3 (7-9): Clear understanding of language choices and effects with relevant quotes and accurate terminology.\n\nLevel 2 (4-6): Some comment on language with some appropriate quotes and some terminology.\nLevel 1 (1-3): Simple comment on language with simple reference.\n\nKey language features:\n* Hyperbole: cannonaded, end of the world -- dramatic exaggeration\n* Personification: sprawled foolishly, defiant and naughty look -- train as misbehaving child\n* Short sentences: I sat up in my bed. / I felt very much annoyed. -- calm understatement\n* Alliteration: fearful force -- emphasis on violence\n* Adverbs: drunkenly, primly, refreshingly -- comic contrast',
      },
      {
        id: 'el_p2j22_q3', source: 'P2 JUN22', marks: 12, type: 'written',
        extract: 'Source A -- Family camping holiday writing (your insert booklet, lines 29-38)\n\nRefer to Source A in your insert booklet. Read lines 29 to 38 carefully -- this section describes a rain storm at the campsite.',
...

  {
    ...
    paper: 'Both papers',
    marks: 20,
    skillTip: 'For Q4 P1: Give your VIEW first, then prove it with quotes and analysis of WHY the writer made those choices. Agree or disagree partially -- show complexity. For Q4 P2: Always link the two texts. Use comparative connectives: In contrast to..., Similarly..., Whereas Source A..., Source B...',
    levelDescriptors: {
    ...
    questions: [
      {
        ...
        extract: 'Source A -- Life of Pi by Yann Martel\nFocus: second part of the source (from line 20 to the end)\n\nFocus on the SECOND PART of the source only -- from line 20 to the end. Re-read this section carefully before answering.',
        ...
        ms: 'Level 4 (16-20): Perceptive, detailed evaluation. Convincing and critical response; perceptive understanding of writer\'s methods; judicious textual detail; evaluates critically the effects on the reader.\n\nLevel 3 (11-15): Clear and relevant evaluation. Clear and relevant response; clear understanding of writer\'s methods; range of relevant references.\n\nLevel 2 (6-10): Some attempts at evaluation. Some response to the statement; some understanding of methods.\n\nLevel 1 (1-5): Simple, limited comment. Simple comment on the text; limited understanding.\n\nStrong answers will:\n* Engage critically with the statement -- neither simply agree nor disagree\n* Consider HOW the hyena\'s wild behaviour creates humour\n* BUT ALSO consider how the threat remains real beneath the comedy\n* Quote specific examples and analyse the writer\'s methods\n* Evaluate what effect this creates on the reader and WHY the writer made these choices',
      },
      {
        id: 'el_p1j22_q4', source: 'P1 JUN22', marks: 20, type: 'written',
        extract: 'Source A -- The Pearl by John Steinbeck\nFocus: second part of the source (from line 19 to the end)\n\nFocus on the SECOND PART of the source only -- from line 19 to the end. Re-read this section carefully before answering.',
        ...
        ms: 'Level 4 (16-20): Perceptive, detailed evaluation.\nExample approach: "Kino\'s instinctive reaction to eliminate the threat is no less effective than Juana\'s. The writer creates contrast through animal imagery -- Juana is presented with eyes as cold as the eyes of a lioness showing controlled maternal determination. Kino is described with violent animal words like snarling, showing primal aggression. Neither is unhelpful."\n\nLevel 3 (11-15): Clear evaluation with methods explained and relevant quotes.\n\nLevel 2 (6-10): Some engagement with the statement.\n\nLevel 1 (1-5): Simple comment.\n\nPoints to evaluate:\n* Kino kills the scorpion -- this IS helpful; the student statement is debatable\n* Animal imagery for both parents\n* Juana\'s iron determination: there was iron in Juana\n* Juana sucks the poison from the baby -- practical and determined\n* Kino leads them to get a doctor',
      },
      {
        id: 'el_p2j23_q4', source: 'P2 JUN23', marks: 16, type: 'written',
        extract: 'Source A and Source B -- your insert booklet (whole of both sources)\n\nSource A: 1920s travel writing -- a bored, experienced traveller on a long train journey\nSource B: An 1830 letter -- experiencing steam train travel for the first time\n\nRe-read the WHOLE of both sources in your insert booklet before answering.',
        ...
        ms: 'Level 4 (13-16): Perceptive, detailed comparison. Analyses how writers\' methods are used; judicious supporting detail from both texts; detailed and perceptive understanding of different ideas and perspectives.\n\nExample of L4: "The writer of Source A expresses contempt for train travel through the repetition and listing of no more, creating a rhythm of exhausted monotony. This contrasts completely with the writer of Source B, whose use of the noun raptures -- with connotations of euphoria -- captures the overwhelming novelty of her very first train experience."\n\nLevel 3 (9-12): Clear and relevant comparison with methods explained and relevant references from both texts.\n\nLevel 2 (5-8): Attempts at comparison; some comment on methods.\nLevel 1 (1-4): Simple cross-reference.\n\nFeelings to compare:\n* Boredom/monotony (A) vs wonder/excitement (B)\n* Contempt/apathy (A) vs admiration/awe (B)\n* Confinement felt (A) vs freedom experienced (B)',
      },
      {
        id: 'el_p2j22_q4', source: 'P2 JUN22', marks: 16, type: 'written',
        extract: 'Source A and Source B -- your insert booklet (whole of both sources)\n\nSource A: Personal writing about a miserable family camping holiday to France\nSource B: Writing celebrating the joys of camping\n\nRe-read the WHOLE of both sources in your insert booklet before answering.',
        ...
        ms: 'Level 4 (13-16): Perceptive, detailed comparison with analysis of methods, judicious textual detail from both, sophisticated understanding of contrasting perspectives.\n\nLevel 3 (9-12): Clear and relevant comparison. Methods clearly explained; relevant references from both texts.\nExample of L3: "The writer of Source A feels that camping is an ordeal, using language that suggests suffering and chaos. Source A uses dark violent language to convey misery, whereas Source B uses positive language to suggest joy and peace."\n\nLevel 2 (5-8): Some attempts at comparison.\nLevel 1 (1-4): Simple cross-reference.\n\nKey contrasts:\n* Attitude to nature: threatening/hostile (A) vs beautiful/restorative (B)\n* Writer\'s tone: resentful, ironic (A); enthusiastic, celebratory (B)\n* Methods: sarcasm and irony (A); lyrical positive vocabulary (B)',
      },
    ],
  },
    ...
    questions: [
      {
        ...
        extract: 'SECTION B -- CREATIVE WRITING\nSpend approximately 45 minutes on this task.\n24 marks: Content and organisation\n16 marks: Technical accuracy (spelling, punctuation, grammar, vocabulary)\n\nA travel website is running a creative writing competition. Read the task below carefully before planning your response.',
        q: 'Section B -- Writing\n\nEither:\nWrite a DESCRIPTION of a wild or remote place.\n\nOr:\nWrite the OPENING of a story about a person who is being closely watched.',
        ms: 'Content and Organisation (24 marks):\nLevel 4 Upper (22-24): Compelling and convincing. Assuredly matched tone/register. Ambitious vocabulary, sustained crafting of linguistic devices. Varied and inventive structural features.\nLevel 4 Lower (19-21): Convincing. Extensive vocabulary with conscious crafting. Varied and effective structural features.\nLevel 3 (14-18): Consistent and clear. Increasingly sophisticated vocabulary. Deliberate structural choices. Clearly organised paragraphs.\nLevel 2 (7-13): Some success. Some varied vocabulary and linguistic devices. Some structural features.\nLevel 1 (1-6): Simple awareness.\n\nTechnical Accuracy (16 marks):\n13-16: Extensive and ambitious vocabulary; varied and inventive sentence structures; high level of accuracy.\n9-12: Increasingly sophisticated vocabulary; variety of sentence structures; generally accurate.\n5-8: Vocabulary chosen for effect; some varied sentences; some accurate spelling and punctuation.\n1-4: Simple vocabulary; simple sentence structures; errors that hinder communication.\n\nKey advice:\n* Vary sentence length deliberately\n* Use all five senses to create vivid description\n* Show not tell\n* Have a distinctive narrative voice',
      },
      {
        ...
        ms: 'Content and Organisation (24 marks) -- same level descriptors as above.\n\nTechnical Accuracy (16 marks) -- same as above.\n\nFor DESCRIPTION: Focus on making the unusual place feel vivid and atmospheric. Use sensory details, interesting viewpoint, structural choices that mirror the place\'s strangeness.\n\nFor STORY: Have a clear narrative arc. Build tension before the rescue. Make the reader care about the character in danger. Strong hook opening.',
      },
      {
        id: 'el_p2j23_q5', source: 'P2 JUN23', marks: 40, type: 'written',
        extract: 'SECTION B -- TRANSACTIONAL WRITING\nSpend approximately 45 minutes on this task.\n24 marks: Content and organisation\n16 marks: Technical accuracy (spelling, punctuation, grammar, vocabulary)\n\nRead the statement below then complete the writing task.',
...

  {
    ...
    questions: [
      ...
      },
      {
        ...
        ms: 'Award up to 2 marks per technique (up to 4 marks total).\n\nAcceptable answers:\n* Metaphor: Revision is a prison with invisible walls -- presents revision as imprisonment, suggesting the writer feels trapped; the word invisible makes it more sinister\n* Metaphor: another hour of my life disappears into the void -- the void suggests an emptiness that consumes time, creating a sense of hopelessness\n* Personification: sunlight waits -- hope is given a human quality of patience, suggesting better times are coming\n* Contrast/juxtaposition: darkness of prison and void contrasted with sunlight -- creates a sense of hope emerging from suffering\n* Short sentence with dashes: But somewhere -- far away -- sunlight waits. -- the dashes slow the reader, creating a sense of longing',
      },
      {
...

  {
    ...
    description: 'Learn the exact paragraph structures AQA rewards. PEEL and how to write analytical paragraphs that gain marks at Level 3 and 4.',
    paper: 'Skills practice',
    marks: 6,
