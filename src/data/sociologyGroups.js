...
export const SOCIOLOGY_GROUPS = [
  {
    ...
    icon: '👨‍👩‍👧',
    accent: '#FF5C7A',
    headerImage: '/headers/sociology-family.png',
    locked: false,
  ...
  },
  {
    ...
    icon: '🎓',
    accent: '#FF8C42',
    headerImage: '/headers/sociology-education.png',
    locked: false,
  ...
  },
  {
    ...
    icon: '⚖️',
    accent: '#A78BFA',
    headerImage: '/headers/sociology-crime.png',
    locked: false,
  ...
  },
  {
    ...
    icon: '📊',
    accent: '#38BDF8',
    headerImage: '/headers/sociology-stratification.png',
    locked: false,
