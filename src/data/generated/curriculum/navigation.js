...
export const NAVIGATION_ENTRIES = [
  {
    ...
    "sections": [
      ...
      },
      {
        ...
        "comingSoon": true,
        "moduleIds": [
          "history-edexcel-early-elizabethan"
        ],
        "cards": []
      },
      {
  ...
  },
  {
    ...
    "pathwayIds": [
      "aqa-biology-8461-foundation",
      "aqa-biology-8461-higher"
    ],
    "cardMode": "chapter",
    "comingSoon": null,
    "sections": null,
  ...
  },
  {
    ...
    "pathwayIds": [
      "aqa-chemistry-8462-foundation",
      "aqa-chemistry-8462-higher"
    ],
    "cardMode": "none",
    "comingSoon": {
  ...
  },
  {
    ...
    "pathwayIds": [
      "aqa-physics-8463-foundation",
      "aqa-physics-8463-higher"
    ],
    "cardMode": "module",
    "comingSoon": null,
    "sections": null,
    "cards": [
      {
        ...
        "kind": "module",
        "moduleId": "physics-aqa-forces-motion",
        "subjectId": "physics",
        "title": "Forces & Motion",
        "subtitle": "AQA Physics · Topic 5 & 6",
        "number": 1,
        "status": "planned",
        "openable": false,
        "heroImage": null,
      ...
      },
      {
        ...
        "kind": "module",
        "moduleId": "physics-aqa-energy",
        "subjectId": "physics",
        "title": "Energy",
        "subtitle": "AQA Physics · Topic 1",
        "number": 2,
        "status": "planned",
        "openable": false,
        "heroImage": null,
      ...
      },
      {
        ...
        "kind": "module",
        "moduleId": "physics-aqa-waves-electricity",
        "subjectId": "physics",
        "title": "Waves & Electricity",
        "subtitle": "AQA Physics · Topic 6 & 2",
        "number": 3,
        "status": "planned",
        "openable": false,
        "heroImage": null,
      ...
      },
      {
        ...
        "kind": "module",
        "moduleId": "physics-aqa-space",
        "subjectId": "physics",
        "title": "Space",
        "subtitle": "AQA Physics · Topic 8",
        "number": 4,
        "status": "planned",
        "openable": false,
        "heroImage": null,
      ...
      },
      {
        ...
        "kind": "module",
        "moduleId": "physics-aqa-matter-particles",
        "subjectId": "physics",
        "title": "Matter & Particles",
        "subtitle": "AQA Physics · Topic 3 & 4",
        "number": 5,
        "status": "planned",
        "openable": false,
        "heroImage": null,
  ...
  },
  {
    ...
    "pathwayIds": [
      "aqa-english-literature-8702-macbeth-inspector"
    ],
    "cardMode": "chapter",
    "comingSoon": null,
    "sections": [
      ...
      },
      {
        ...
        "comingSoon": true,
        "moduleIds": [
          "english-lit-aqa-inspector-calls"
        ],
        "cards": [
          {
...
export function getNavigationEntryById(id) {
  return NAVIGATION_ENTRIES.find(entry => entry.id === id) ?? null
}

export function getNavigationEntryForDisplayName(name) {
  return NAVIGATION_ENTRIES.find(entry => entry.label === name) ?? null
}
