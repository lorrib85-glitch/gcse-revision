...
export const CHAPTERS = [
  {
    ...
    screenTags: [
      ...
      null, "medieval-practitioners", "miasma", null, null, null, null, null, null, null,
  ...
  },
  {
    ...
    screenCount: 24,
    screenTags: [
      null, null, null, null, null, null, null, null, null, null, "plague-explanations",
  ...
  },
  {
    ...
    screenCount: 16,
    screenTags: [
      null, null, null, null, "vesalius", null, null, null, null, null, null, null, null,
      null, null, null,
    ],
    availability: "hidden",
  },
  {
    ...
    screenCount: 12,
    screenTags: [null, null, null, "vesalius", null, null, "printing-press", null, null, null, null, null],
  },
  {
    ...
    screenCount: 11,
    screenTags: [null, null, null, "harvey", null, null, "pare", null, null, null, null],
  },
  {
    ...
    screenCount: 11,
    screenTags: [null, "anaesthetics", null, null, null, null, null, null, "antiseptic-surgery", null, null],
  },
  {
    ...
    screenCount: 11,
    screenTags: [
      null, "great-plague", null, null, "plague-explanations", null, null, null, "plague-comparison",
      null, null,
    ],
  },
  {
  ...
  },
  {
    ...
    screenCount: 10,
    screenTags: ["germ-theory", "pasteur", "koch", null, null, null, null, null, null, null],
  },
  {
    ...
    screenCount: 7,
    screenTags: [null, null, null, "john-snow", "public-health", null, null],
  },
  {
    ...
    screenCount: 10,
    screenTags: [null, null, null, null, null, null, null, null, null, null],
  },
  {
  ...
  },
  {
    ...
    screenCount: 11,
    screenTags: [null, "magic-bullet", "penicillin", null, null, "wwi-medicine", null, null, null, null, null],
  },
  {
  ...
  },
  {
    ...
    screenCount: 11,
    screenTags: [null, null, null, null, null, null, null, null, null, null, null],
  },
  {
    ...
    screenCount: 19,
    screenTags: [
      "prior-knowledge-western-front", "western-front-context", "trench-conditions", "trench-conditions-recall",
      "chain-of-evacuation", "chain-of-evacuation-recall", "medical-developments", "thomas-splint",
      "blood-transfusions", "medical-developments-recall", "source-utility", "source-follow-up",
      "western-front-core-recall", "describe-two-features", "describe-two-features", "source-utility-exam",
      "source-utility-exam", "source-follow-up", null,
    ],
  },
  {
  ...
  },
  {
    ...
    screenCount: 14,
    screenTags: [null, null, null, null, null, null, null, null, null, null, null, null, null, null],
  },
  {
    id: "sci_bio_w1",
    subject: "Biology",
  ...
  },
  {
    ...
    screenCount: 13,
    screenTags: [
      "maths:place-value", null, "maths:place-value", "maths:place-value", null, "maths:ordering-numbers",
      "maths:ordering-numbers", null, "maths:place-value", null, null, "maths:ordering-numbers",
      null,
    ],
  },
  {
    ...
    screenCount: 14,
    screenTags: [
      "maths:four-operations", null, "maths:written-methods", "maths:written-methods", "maths:four-operations",
      "maths:four-operations", null, "maths:four-operations", null, "maths:four-operations",
      null, null, "maths:four-operations", null,
    ],
  },
  {
    id: "math3",
    ...
    screenCount: 14,
    screenTags: [
      "maths:negative-numbers", null, "maths:ordering-negatives", "maths:negative-numbers",
      "maths:negative-numbers", "maths:negative-numbers", "maths:negative-numbers", null,
      "maths:negative-numbers", null, "maths:negative-numbers", null, "maths:ordering-negatives",
      null,
    ],
  },
  {
    ...
    screenCount: 13,
    screenTags: [
      "maths:bidmas", null, "maths:bidmas", "maths:bidmas", "maths:bidmas", "maths:calculator-control",
      "maths:bidmas", null, "maths:bidmas", null, null, "maths:calculator-control", null,
    ],
  },
  {
    id: "math5",
    ...
    screenCount: 15,
    screenTags: [
      "maths:significant-figures", null, "maths:rounding", "maths:significant-figures", "maths:estimation",
      "maths:estimation", "maths:rounding", "maths:rounding", "maths:estimation", null, "maths:rounding",
      null, null, "maths:significant-figures", null,
    ],
  },
  {
    id: "math6",
    ...
    screenCount: 14,
    screenTags: [
      "maths:prime-numbers", null, "maths:prime-numbers", "maths:prime-numbers", "maths:prime-factorisation",
      "maths:hcf-lcm", "maths:hcf-lcm", "maths:prime-factorisation", null, "maths:hcf-lcm",
      null, null, "maths:hcf-lcm", null,
    ],
  },
  {
    id: "math7",
    ...
    screenCount: 14,
    screenTags: [
      "maths:standard-form", null, "maths:powers-roots", "maths:indices", "maths:standard-form",
      "maths:standard-form", "maths:standard-form", "maths:standard-form", null, "maths:standard-form",
      null, null, "maths:indices", null,
    ],
  },
  {
    id: "math8",
    ...
    screenCount: 14,
    screenTags: [
      "maths:equivalent-fractions", null, "maths:equivalent-fractions", "maths:simplifying-fractions",
      "maths:mixed-numbers", "maths:fractions-of-amounts", "maths:simplifying-fractions",
      "maths:fractions-of-amounts", null, "maths:simplifying-fractions", null, null, "maths:fractions-of-amounts",
      null,
    ],
  },
  {
...
export const CHAPTER_AVAILABILITY = { AVAILABLE: 'available', COMING_SOON: 'comingSoon', HIDDEN: 'hidden' }

export function getChapterAvailability(chapter) {
  if (!chapter) return CHAPTER_AVAILABILITY.HIDDEN
  if (chapter.availability) return chapter.availability
  return chapter.screenCount > 0 ? CHAPTER_AVAILABILITY.AVAILABLE : CHAPTER_AVAILABILITY.COMING_SOON
}

export function isChapterAvailable(chapter) {
  return getChapterAvailability(chapter) === CHAPTER_AVAILABILITY.AVAILABLE
}
