...
export const KNOWN_SENTENCE_CASE_VIOLATIONS = {
  "history-medicine-medieval-beliefs-causes": [
    ...
    "SENTENCE_CASE:screens[14].label:run:1",
    "SENTENCE_CASE:screens[14].label:run:2",
    "SENTENCE_CASE:screens[15].label:run:0",
    "SENTENCE_CASE:screens[17].theories[1].label:run:0",
    "SENTENCE_CASE:screens[1].label:run:0",
    "SENTENCE_CASE:screens[21].hotspots[2].title:run:0",
    "SENTENCE_CASE:screens[21].label:run:0",
    "SENTENCE_CASE:screens[21].label:run:1",
    "SENTENCE_CASE:screens[21].label:run:2",
    "SENTENCE_CASE:screens[24].label:run:0",
