...
const LEGACY_PRESENTATION_FIELDS = {
  'history-medicine-medieval-beliefs-causes': ['screens[20].blocks[0].columns[0].bg','screens[20].blocks[0].columns[0].color','screens[20].blocks[0].columns[1].bg','screens[20].blocks[0].columns[1].color','screens[24].columns[0].bg','screens[24].columns[0].color','screens[24].columns[0].colorRgb','screens[24].columns[1].bg','screens[24].columns[1].color','screens[24].columns[1].colorRgb'],
