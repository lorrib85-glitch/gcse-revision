...
const LEGACY_PRESENTATION_FIELDS = {
  ...
  'history-medicine-vesalius-beginning-doubt': ['screens[8].columns[0].bg','screens[8].columns[0].color','screens[8].columns[0].colorRgb','screens[8].columns[1].bg','screens[8].columns[1].color','screens[8].columns[1].colorRgb'],
