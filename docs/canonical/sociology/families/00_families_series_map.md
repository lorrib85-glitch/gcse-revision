# Families and households — Series map

## Series identity

- **Subject:** Sociology
- **Exam board / spec:** AQA GCSE Sociology (8192)
- **Assessment:** Paper 1 (8192/1) — Section A: Families
- **Marks / time:** 50 marks (Section A) / Paper 1 is 1 hour 45 minutes total
- **12-mark question format:** "Discuss how far sociologists would agree that…" — two questions per paper, 12 marks each (AO1: 4, AO2: 4, AO3: 4)
- **Episode count:** 10 episodes
- **Series central hook:** Who gets to decide what a "normal" family is?

---

## Series throughline

The family looks natural. Sociology asks: who benefits when we call one version of family "normal"? Every perspective on the family — functionalist, Marxist, feminist, New Right — reflects a different answer to this question. The module builds from definitions and diversity toward competing theoretical arguments, so that by Episode 10 students can construct a coherent 12-mark argument using named sociologists and evaluation.

**The question every episode must answer:** How does this sociological idea help us understand who the family serves, and at what cost to whom?

---

## Module architecture (embedded)

Every episode follows this 7-stage rhythm:

### Stage 1 — Hook & prior recall
**Purpose:** Surface existing knowledge, create curiosity, prime retrieval. A real-life question, dilemma or scenario the student already has an intuition about.
- Typical components: `ChapterHookScreen`, `PriorKnowledgeRecall`, `MisconceptionCheck`

### Stage 2 — Core concept decode
**Purpose:** Precise definition of the episode's key concepts. One concept at a time. No theory yet — just what the words mean.
- Typical components: `ConceptReveal`, `VisualLearning`, `FillInTheBlanksBlock`

### Stage 3 — Sociologist evidence
**Purpose:** Introduce the named researcher(s) for this episode: perspective, key claim, one concrete finding or quote. Students must be able to write "X argues that…" correctly.
- Typical components: `KeyFigureReveal`, `TheoryCompareBlock`, `MatchingTask`

### Stage 4 — Challenge & perspectives
**Purpose:** The opposing view, the limitation, or the competing perspective. Every theory taught here must be challenged. Students should leave knowing the main evaluation point.
- Typical components: `MisconceptionCheck`, `ColSortBlock`, `SwipeSort`, `TheoryCompareBlock`

### Stage 5 — Apply & scenario
**Purpose:** Apply the concepts and theories to a realistic scenario. Card sorts, item questions, decision tasks. Methods link where relevant.
- Typical components: `ColSortBlock`, `InteractiveCollectionExplorer`, `SwipeSort`, `MatchingTask`

### Stage 6 — Exam build
**Purpose:** At least one AQA-style practice moment: 3-mark describe, 4-mark identify-and-explain, or a 12-mark paragraph builder. Feed `FaceTheExaminer` and `GuidedAnswerCoach`.
- Typical components: `FaceTheExaminer`, `GuidedAnswerCoach`, `GuidedExamResponse`, `ExaminerExplainsScreen`

### Stage 7 — Quick fire retrieval
**Purpose:** Five retrieval questions drawing on this episode and at least one earlier episode. Every episode's retrieval feeds the next episode's hook.
- Typical components: `QuickRecallScreen`, `RecoveryQuizPlayer`

---

## 10-point Sociology Module Completion Test
...
|---|-------|------------|---------------------|-------------------|
| 1 | What counts as a family? | Definitions, family types, household vs family | None — concepts only | Very high |
| 2 | The normal family trap | Conventional family, Oakley, social control | Feminist | Very high |
| 3 | What is the family for? | Functionalist functions (Murdock, Parsons) | Functionalism | Very high |
| 4 | One shape does not fit all | Family diversity, Rapoport and Rapoport | Diversity research | Very high |
| 5 | Who does the work at home? | Conjugal roles, domestic division of labour | Feminist, Functionalist | Very high |
| 6 | The symmetrical family: real change or PR spin? | Symmetrical family debate | Feminist vs Functionalist | Very high |
| 7 | The family under attack | Marxist + feminist criticisms, dark side | Marxist, Feminist | Very high |
| 8 | Parents, children and power | Changing parent-child relationships, childhood | Functionalist, Conflict | High |
| 9 | Marriage, cohabitation and divorce | Divorce trends, reasons, consequences | Functionalist, Feminist, New Right | Very high |
| 10 | The 12-mark family argument lab | Essay construction, AO1/AO2/AO3 | All perspectives | Very high |
...
### Episode 1: What counts as a family?

- **Big question:** Is a family defined by biology, law, love, or living together?
- **Syllabus coverage:**
  - Definitions: family vs household (precise distinction)
  - Nuclear family (two-generation: married/cohabiting parents + children)
  - Extended family (classic three-generation vs modified extended)
  - Lone-parent (single-parent) family
  - Reconstituted (blended/step) family
  - Same-sex family
  - Beanpole family (multigenerational, few members per generation)
  - Cohabitation
  - Civil partnership
  - Living Apart Together (LAT) couples
  - Life-course diversity — different household types across one person's life
- **Key concepts / vocabulary:**
  - Family: people linked by birth, marriage, civil partnership, adoption or cohabitation in long-term relationships
  - Household: one person living alone, or a group sharing an address and facilities — not always a family
  - Family household vs non-family household
  - Life course: culturally defined sequence of age categories from birth to death
  - Dependent children
  - Cohabitation: living with a partner outside of marriage
...
- **Exam skill focus:** 3-mark describe (identify and describe one family type) and 4-mark identify-and-explain (explain one difference between a family and a household)
...
### Episode 2: The normal family trap

- **Big question:** Who invented the idea of the "normal" family — and who does it serve?
- **Syllabus coverage:**
...
- **Exam skill focus:** 3-mark describe (describe the conventional family) and 4-mark apply (apply Oakley's argument to a short scenario)
- **Likely misconceptions:**
...
### Episode 3: What is the family for?

- **Big question:** Does the family exist to serve society — or to serve certain groups within it?
- **Syllabus coverage:**
  - Functionalist perspective: family as essential to social order
  - Murdock's four functions of the nuclear family: sexual, reproductive, economic, educational (socialisation)
  - Parsons' two key functions: primary socialisation of children + stabilisation of adult personalities
  - Instrumental role (male, breadwinner, disciplinarian) and expressive role (female, emotional/caring, childcare)
  - Evaluation of functionalism: ignores conflict, out of date (women now work), ignores family diversity
  - Marxist perspective (Engels): isolated nuclear family enables men to confirm paternity and ensure wealth stays within the family through private inheritance → maintains capitalism
  - New Right perspective (Charles Murray): nuclear family encourages self-sufficiency, reduces welfare expenditure, passes on shared moral values — lone-parent families produce an "underclass"
  - Evaluation of New Right: exaggerates decline of the nuclear family; most lone parents want to work
- **Key concepts / vocabulary:**
  - Functionalism: society works as a system where each part (including the family) performs essential functions
  - Primary socialisation: learning norms and values in early childhood, usually within the family
  - Stabilisation of adult personalities: the family provides emotional support and stability for adults (Parsons' "warm bath" theory)
  - Instrumental role: rational, breadwinner, disciplinarian function (typically male — Parsons)
  - Expressive role: emotional, caring, domestic function (typically female — Parsons)
  - New Right: conservative perspective; supports the nuclear family; critical of lone-parent and welfare-dependent families
  - Underclass (Murray): group at the bottom of society characterised by dependency on welfare
- **Named evidence:**
  - **George Murdock** (functionalist): four functions of the nuclear family — sexual (regulate sexual behaviour), reproductive (produce next generation), economic (provide food/shelter/resources), educational (socialise children into norms and values). Source: *Social Structure*, 1949.
  - **Talcott Parsons** (functionalist): two irreducible functions — primary socialisation + stabilisation of adult personalities. Instrumental + expressive role distinction. Source: 'The social structure of the family', *The Family: Its Functions and Destiny*, 1959.
  - **Friedrich Engels** (Marxist): the isolated nuclear family enables private property inheritance; men need to know paternity to pass on wealth → family protects capitalism. Source: *The Origin of the Family, Private Property and the State*, 1884.
  - **Charles Murray** (New Right): nuclear family best for self-reliance and moral values; lone-parent families produce welfare dependence and an underclass. *Losing Ground*, 1984.
- **Active learning interactions:**
