# Episode 8: Parents, children and power — Architecture

## 1. Identity

- **Episode:** 8
- **Title:** Parents, children and power
- **Subject:** Sociology — AQA 8192, Paper 1 Section A (Families and households)
- **Build status:** Not yet built
- **Content file:** `08_Parents_children_and_power_Content.md`
...
- **Proposed:** "Are you more independent than your parents were at your age?" Connect to teenager's lived experience. Retrieve Episode 4 beanpole family and sandwich generation concepts, plus Episode 6's point that family relationships can look more equal without power disappearing.
- **Components:** `ChapterHookScreen`, `PriorKnowledgeRecall`

### Stage 2 — Core concept decode
- **Proposed:** Changing parent-child relationships over time. Teach pre-industrial, industrial and contemporary/modern relationships first. Then decode authoritarian vs child-centred relationships, children's rights, financial dependence and wider kinship networks.
...
- **Proposed:** Challenge the simple March of Progress view. Parent-child relationships may be warmer and more child-centred, but independence is uneven. Class, ethnicity, migration, gender, poverty, housing costs and ageing population shape experiences. Add a light Aries/social-construct link only where useful.
- **Components:** `MisconceptionCheck`, `TheoryCompareBlock`

### Stage 5 — Apply & scenario
- **Proposed:** Then vs now comparison: child labour / authoritarian relationships / child-centred family. Dependency slider: when does adulthood actually start — financially, legally, socially and emotionally? Kinship network map: who gives support to whom across generations?
- **Components:** `VisualLearning`, `TimelineChain`, scenario cards

### Stage 6 — Exam build
- **Proposed:** 4-mark explain: explain one way parent-child relationships have changed. 4-mark explain: explain one reason young people may remain financially dependent for longer. 4-mark explain: explain one way wider kinship networks may still support families. 12-mark preparation: build a balanced answer on whether childhood and parent-child relationships have improved over time.
...
- Then vs now comparison: pre-industrial / industrial / contemporary parent-child relationships
- Authority slider: authoritarian → negotiated → child-centred
...
- `MisconceptionCheck`: "The wider family has disappeared" — false; support may continue through modified extended families
- 4-mark practice: explain one way parent-child relationships have changed
- 4-mark practice: explain one way wider kinship networks may still support families
...
This connects directly to teenage life: independence, parents, rules, money, school, leaving home and returning home.
