...
|---|-------|----|--------------|-----------------|---------------------|
| 1 | Trust me, I'm following Jupiter | `history-medicine-medieval-beliefs-causes` | built (32 screens) | inline | Extract when convenient |
...
|-------|-------|---------|
| Extracted (registry complete) | 3 | 7, 14, 6 (stub) |
| Built, inline (awaiting extraction) | 9 | 1, 2, 3, 4, 8, 9, 11, 12, 13 |
| Unbuilt | 2 | 5, 10 |
