...
- **Proposed content:**
  ...
  - Context: Divine right of kings — "He's here in double trust": kinsman, subject, host; the three broken bonds
...
- **Proposed content:**
  - **"He's here in double trust"**: AO2: the listing structure (anaphora of "He is my"); "double" understates — it is triple/compound; whole-play link: this compound betrayal is why the murder generates cosmic consequences
...
- **Purpose:** AQA-style practice — this episode is the 2024 actual exam question.
- **Proposed content:**
...
4. **Section 5 — use the actual 2024 past paper question and extract:** This is the single highest-value exam practice opportunity in the series. The GuidedExamResponse should model a 4-paragraph structure explicitly. Students should see both the model paragraph and the mark scheme language.
