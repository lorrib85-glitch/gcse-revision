# Episode 3: The prophecy trap — Content
...
- **Secondary act links:** Act 3 Scene 1 · Act 4 Scene 1 · Act 5 Scene 8
- **Core focus:** Macbeth and Banquo react differently to the witches, revealing Macbeth's vulnerability to ambition
- **Retrieval priority:** Very high — one of the best scenes for Macbeth, Banquo, supernatural and ambition questions
...
This episode is the causal hinge of the series. Without the witches' prophecies in 1.3, none of what follows happens. But the episode's lesson — that Macbeth is already susceptible before the prophecies are made — threads through to Episode 11 (4.1): when Macbeth returns to the witches seeking reassurance, he is repeating the same error. Both visits show Macbeth using supernatural authority to justify decisions he has already made internally. Banquo's warning in this episode ("win us with honest trifles, to betray's") is exactly what happens to Macbeth throughout the play.

### Exam framing

Very high retrieval priority. This episode supports:
- Any question on the supernatural — Act 1.3 is the most frequently discussed supernatural scene
- Any question on Macbeth's character and ambition — his aside reveals pre-existing ambition
- Any question on fate vs free will — Banquo/Macbeth contrast is the purest expression of this theme
- Any extract-based question from 1.3 — the "horrid image" aside or the "instruments of darkness" exchange would be prime extract choices
...
- Understanding of the witches' prophecies and their effect on Macbeth and Banquo
- Understanding of the contrast between Macbeth's and Banquo's responses as Shakespeare's method for revealing character
- Understanding of the aside as a dramatic technique (access to Macbeth's inner thoughts)
- Understanding of equivocation as a theme introduced through the witches' language
- Understanding of fate vs free will as the central tension of the scene
- Understanding of AO3 context: Jacobean fear of witchcraft; King James I and *Daemonologie*; the nature of prophecy and its relationship to free will in Christian theology
- Understanding of AO2: how Shakespeare uses paradox, the aside, imagery and contrast to present the prophecy trap
...
- Act 1 Scene 3: Set on a heath; immediately after the opening battle
- The witches have been waiting — their plan was always to intercept Macbeth here
- Three prophecies delivered: Thane of Glamis (already true), Thane of Cawdor (about to be confirmed), "shalt be king hereafter" (future/uncertain)
- Banquo receives the paradoxical prophecies: "lesser than Macbeth, and greater"
- Ross and Angus arrive to confirm the Cawdor title → the first prophecy is immediately fulfilled → Macbeth's susceptibility deepens
...
- **Prophecy:** A prediction of future events; the witches' prophecies are not *commands* but *predictions*; Macbeth chooses to act on them
- **Aside:** A dramatic convention where a character speaks to the audience but not to other characters on stage; Macbeth's asides in 1.3 give the audience access to his private thoughts
...
- "How does Shakespeare present the supernatural in this extract and in the play as a whole?" — Act 1.3 is the primary text for this question
- "How does Shakespeare present ambition in Macbeth?" — Macbeth's aside reveals ambition as pre-existing, not witchcraft-induced
- "How does Shakespeare use the contrast between Macbeth and Banquo?" — the different responses to the same prophecies are the primary vehicle for this theme
- "How far is Macbeth responsible for his own downfall?" — Act 1.3 is the crucial scene; his choice to "yield" is documented in his own aside

**Mark scheme patterns:**
- AO1: Any question about Macbeth's character must acknowledge his agency — the aside proves he has free will (AQA Jun 2023 indicative: "role of the witches/supernatural on Macbeth's changing")
- AO2: The aside as a technique; paradox in the witches' language; the word "horrid" (pre-moral revulsion that does not stop him)
- AO3: Jacobean belief in witchcraft as genuinely threatening; James I's *Daemonologie*; equivocation (Gunpowder Plot context — the Jesuit doctrine of equivocation was a live political issue in 1606)
...
- **Spine file:** Episode 3 structure, must-include quotes, theme/context/exam tags
- **PMT Context PDF:** Holinshed's Chronicles (witches originally "goddesses of destine"); James I connection; equivocation and Gunpowder Plot
- **JOG Revision Booklet:** Quote analysis for "instruments of darkness"; equivocation as theme; Banquo/Macbeth contrast
- **PMT Character Profiles:** Macbeth's hamartia as revealed (not created) by witches; predestination vs free will
- **Save My Exams:** Supernatural theme analysis; fate vs free will; ambition as pre-existing
- **AQA past papers:** Act 1.3 not used as extract in available papers (Jun 2024, Jun 2023, Nov 2021) but the themes it introduces are central to all Macbeth questions; suitable for a York Notes practice extract
